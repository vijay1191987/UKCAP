<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="tophead.ascx.cs" Inherits="WebApplication1.lokaseba_adhikar.controls.tophead" %>
<div class="row">
    <div class="col-lg-12 outertop">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 ptop10 pull-right">
            <div class="col-sm-3 col-xs-6 pleft0">
                <a href="/WebApp/Charts/dashboard.aspx">
...
<%--<div class="str1 str_wrap ptop10 topmarquee_bg">&nbsp; &nbsp; <img src="/g2c/img/NewAlt.gif" alt="Latest News" width="25">  Result of Written Examination for Recruitment of Constables in 9<sup>th</sup> SIRB held on 09.04.2017 <a href="/pdf/writtenExamination_IRBS_English.PDF" style="background-color: #e53935;
    color: #fff; padding: 5px 8px; border-radius: 2px; font-size:12px;"><i class="fa fa-hand-o-right mtop10"></i> Click Here</a>
    "Advertisement for written examination for the post of
