<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="footer_odia.ascx.cs" Inherits="CitizenPortal.g2c.controls.footer_odia" %>
        ...
        <div class="col-lg-8 col-xs-12">
            <nav class="bottomnavbar">
                <ul>
                    ...
                    <li><a href="../forms/sitemap_odia.aspx">Sitemap</a>|</li>
                    <%--<li><a href="#">Help</a>|</li>--%>
