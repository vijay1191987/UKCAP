<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="UkAttachment.aspx.cs" Inherits="CitizenPortal.WebAppUK.forms.UkAttachment" %>
                                    ...
                                    <asp:TemplateField HeaderText="Download">
                                        <ItemTemplate>
                                            ...
                                            <asp:HyperLink ID="hlMySite" runat="server" ToolTip="Click to download the file"
                                                NavigateUrl='<%# Eval("Path") %>' Target="_blank" Visible='<%# Convert.ToBoolean( Eval("IsUploaded")) %>'
                                                Text="Download"> <img src="/WebApp/Kiosk/Images/download.png" style="width:50px;height:50px"></img></asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
