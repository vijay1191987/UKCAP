<%@ Page Title="" Language="C#" MasterPageFile="~/WebAppUK/master/UKAdmin.Master" AutoEventWireup="true" CodeBehind="NightBooking.aspx.cs" Inherits="CitizenPortal.WebAppUK.JimCorbett.NightBooking" %>
    ...
    <div id="page-wrapper" style="min-height: 500px !important;">
        <div class="container-fluid">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <h2 class="form-heading" style="margin: 15px auto;"><i class="fa fa-pencil-square-o fa-fw"></i>Night Booking</h2>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 box-container">
                ...
                <div class="box-body box-body-open">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                            <div class="form-group">
                                <label class="manadatory">Checkin Date</label>
                                <input type="text" id="CheckinDate" class="form-control" placeholder="DD/MM/YYYY" />
                            </div>
                        </div>
                    <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                            <div class="form-group">
                                <label class="manadatory">Checkout Date</label>
