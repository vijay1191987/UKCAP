<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Certificate.aspx.cs" Inherits="CitizenPortal.WebAppUK.DeathCertificate.Certificate" %>
                        ...
                        <tr>
                            <td>
                                <table style="width: 700px; border: 2px solid #212121; font-family: Arial, Helvetica, sans-serif; background-image: url(../img/certificate_logo_bg.png); background-size: 590px; background-repeat: no-repeat; background-position: center center;">
                                    <tr>
                                        <td colspan="3" style="padding: 8px 0; text-align: left;"><span style="font-size: 13px; padding: 15px;">S.NO 434369</span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td style="text-align: center;"><span style="font-size: 20px; font-weight: bold;">DEATH CERTIFICATE</span></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" style="padding: 8px; text-align: justify; font-size: 14px;">({{resourcesData.lblIUs}}<asp:Label ID="Label1" runat="server"></asp:Label>
                                    ...
                                    <tr>
                                        <td style="padding: 15px; font-size: 13px; text-align: left;">{{resourcesData.lblAppDOD}}</td>
                                        <td colspan="2" style="padding: 8px; text-align: left;">
                                            <asp:Label ID="Label4" runat="server"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 15px; font-size: 13px; text-align: left;">{{resourcesData.lblplaceofdeath}}</td>
                                        <td colspan="2" style="padding: 8px; text-align: left;">
                                ...
                                <td colspan="2" style="padding: 8px; text-align: left;"><asp:Label ID="Label11" runat="server"></asp:Label></td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="padding: 8px; text-align: right; font-size: 14px;"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="padding: 15px; font-size: 13px; border-bottom: 1px solid #000; text-align: left;">{{resourcesData.lblDateofissue}}</td>
