...
function SubmitData() {
    ...
    var datavar = {
        ...
        'StatusPoint': $('#txtStatusPoints').val(),
        'StatusTerm': $('#txtStatusTerms').val(),
    ...
    $.when(
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: '/WebAppUK/EDistrict/SolvencyCertificate/SolvencyForm.aspx/InsertSolvencyCertificateData',
...
function Reset() {
    ...
    window.location.href = '/WebAppUK/Edistrict/SolvencyCertificate/SolvencyForm.aspx?SvcID=' + svcid + '&DPT=' + dpt + '&DIST=' + dist + '&BLK=' + blk + '&PAN=' + pan + '&OFC=' + ofc + '&OFR=' + ofr + '&UID=' + uid + '';
}
