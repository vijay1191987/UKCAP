<%@ Page Title="" Language="C#" MasterPageFile="~/WebAppUK/master/UKAdmin.Master" ClientIDMode="Static" AutoEventWireup="true" CodeBehind="SolvencyForm.aspx.cs" Inherits="CitizenPortal.WebAppUK.EDistrict.SolvencyCertificate.SolvencyForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="/WebAppUK/Edistrict/SolvencyCertificate/SolvencyCertificate.js?v=<%=CitizenPortal.Common.GlobalValues.JSVersion%>"></script>
            ...
            <div class="container-fluid">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <h2 class="form-heading" style="margin: 15px auto;">
                        <span class="col-lg-9 p0" style="font-family: Arial !important; font-size: 22px;"><i class="fa fa-pencil-square-o fa-fw"></i>SOLVENCY CERTIFICATE
                        </span>
                        ...
                        <div class="box-body box-body-open">
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="txtMobileNo" placeholder="Mobile" autocomplete="off" maxlength="10" class="form-control" onchange="MobileValidation(txtMobileNo)" />
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label class="manadatory">{{resourcesData.lblInStatusPoint}}</label>
                                    <input type="text" id="txtStatusPoints" placeholder="Status Points" class="form-control" maxlength="28" />
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>{{resourcesData.lblInTermsofStatus}}</label>
                                    <input type="text" id="txtStatusTerms" placeholder="Status Terms" class="form-control" maxlength="28" />
                                </div>
                            </div>
