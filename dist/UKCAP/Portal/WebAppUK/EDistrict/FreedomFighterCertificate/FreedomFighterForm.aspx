<%@ Page Title="" Language="C#" MasterPageFile="~/WebAppUK/master/UKAdmin.Master" ClientIDMode="Static" AutoEventWireup="true" CodeBehind="FreedomFighterForm.aspx.cs" Inherits="CitizenPortal.WebAppUK.EDistrict.FreedomFighterCertificate.FreedomFighterForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="/WebAppUK/Edistrict/FreedomFighterCertificate/FreedomFighter.js?v=<%=CitizenPortal.Common.GlobalValues.JSVersion%>"></script>
        ...
        <div class="container-fluid">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <h2 class="form-heading" style="margin: 15px auto;">
                    <span class="col-lg-9 p0" style="font-family: Arial !important; font-size: 22px;"><i class="fa fa-pencil-square-o fa-fw"></i>FREEDOM FIGHTER CERTIFICATE
                    </span>
                    ...
                    <div class="box-body box-body-open">
                        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                            <div class="form-group">
                                <label class="manadatory">{{resourcesData.lblCertificateType}}</label>
                                <select class="form-control" id="ddlCertificateType">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-2 col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="DateOfBirth" placeholder="DD/MM/YYYY" class="form-control" maxlength="10" onkeypress="return false" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                <label class="">{{resourcesData.appage}}</label>
                                <input type="text" id="txtAgeDetail" readonly="true" placeholder="Age Detail" class="form-control" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                            <div class="form-group">
                         ...
                         <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                            <div class="form-group">
                                <label>{{resourcesData.lblMobileNo}}</label>
                                <input type="text" id="txtMobileNo" placeholder="Mobile" maxlength="10" class="form-control" onchange="MobileValidation(txtMobileNo)" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                <label class="manadatory">{{resourcesData.lblFreedomFighterName}}</label>
                                <input type="text" id="txtFFName" class="form-control" placeholder="Freedom Fighter Name" maxlength="40" onkeypress="ForName(event);" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                <label class="manadatory">{{resourcesData.lblFFighterFatherName}}</label>
                                <input type="text" id="txtFFFName" class="form-control" placeholder="Father Name(Freedom Fighter)" maxlength="40" onkeypress="ForName(event);" />
                            </div>
                        </div>
                ...
                <div class="box-body box-body-open">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="txtPincode" class="form-control" placeholder="Pincode" maxlength="6" onkeypress="return return isNumber(event);" onchange="PinCodeValidation(this);" />
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
