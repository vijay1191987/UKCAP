...
function ValidateForm()
{
    ...
    {
        text += "<BR>" + " \u002A" + " Please Enter Freedom Fighter Name.";
        $('#txtFFName').attr('style', 'border:1px solid #d03100 !important;');
        $('#txtFFName').css({ "background-color": "#fff2ee" });
        opt = 1;
    } else
    {
        $('#txtFFName').attr('style', '1px solid #cdcdcd !important;');
        $('#txtFFName').css({ "background-color": "#ffffff" });
    }

    var FFFName = $('#txtFFName').val();
    if (FFFName == null || FFFName == "")
    {
        text += "<BR>" + " \u002A" + " Please Enter Freedom Fighter Father's Name.";
        $('#txtFFFName').attr('style', 'border:1px solid #d03100 !important;');
        $('#txtFFFName').css({ "background-color": "#fff2ee" });
        opt = 1;
    } else
    {
        $('#txtFFFName').attr('style', '1px solid #cdcdcd !important;');
        $('#txtFFFName').css({ "background-color": "#ffffff" });
    }
...
function SubmitData()
{
    ...
    var datavar = {
        ...
        'FreedomFighterName': $('#txtFFName').val(),
        'FreedomFighterFatherName': $('#txtFFFName').val(),
    ...
    $.when(
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: '/WebAppUK/EDistrict/FreedomFighterCertificate/FreedomFighterForm.aspx/InsertFreedomFighterData',
...
function Reset()
{
    ...
    window.location.href = '/WebAppUK/EDistrict/FreedomFighterCertificate/FreedomFighterForm.aspx?SvcID=' + svcid + '&DPT=' + dpt + '&DIST=' + dist + '&BLK=' + blk + '&PAN=' + pan + '&OFC=' + ofc + '&OFR=' + ofr + '&UID=' + uid + '';
}
