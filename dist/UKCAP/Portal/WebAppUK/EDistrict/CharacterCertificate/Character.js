...
function ValidateForm()
{
    ...
    if (CertificateType == "0" || CertificateType == "-Select-")
    {
        text += "<BR>" + " \u002A" + " Please Select Type of Character Certificate From List.";
        $('#ddlCertificateType').attr('style', 'border:1px solid #d03100 !important;');
        $('#ddlCertificateType').css({ "background-color": "#fff2ee" });
        opt = 1;
    } else
    {
        $('#ddlCertificateType').attr('style', '1px solid #cdcdcd !important;');
        $('#ddlCertificateType').css({ "background-color": "#ffffff" });
    }
    ...
    var EduQualification = $('#ddlEduQualification').val();
    if (EduQualification == "0" || EduQualification == "-Select-")
    {
        text += "<BR>" + " \u002A" + " Please Select Educational Qualification From List.";
        $('#ddlEduQualification').attr('style', 'border:1px solid #d03100 !important;');
        $('#ddlEduQualification').css({ "background-color": "#fff2ee" });
        opt = 1;
    } else
    {
        $('#ddlEduQualification').attr('style', '1px solid #cdcdcd !important;');
        $('#ddlEduQualification').css({ "background-color": "#ffffff" });
    }

    var Purpose = $('#ddlPurpose').val();
    if (Purpose == "0" || Purpose == "-Select-")
    {
        text += "<BR>" + " \u002A" + " Please Select Certificate Purpose From List.";
        $('#ddlPurpose').attr('style', 'border:1px solid #d03100 !important;');
        $('#ddlPurpose').css({ "background-color": "#fff2ee" });
        opt = 1;
    } else
    {
        $('#ddlPurpose').attr('style', '1px solid #cdcdcd !important;');
        $('#ddlPurpose').css({ "background-color": "#ffffff" });
    }

    var Punishment = $('#ddlPunishmentType').val();
    if (Punishment == "0" || Punishment == "-Select-")
    {
        text += "<BR>" + " \u002A" + " Please Select Court Punishment From List.";
        $('#ddlPunishmentType').attr('style', 'border:1px solid #d03100 !important;');
        $('#ddlPunishmentType').css({ "background-color": "#fff2ee" });
        opt = 1;
    } else
    {
        $('#ddlPunishmentType').attr('style', '1px solid #cdcdcd !important;');
        $('#ddlPunishmentType').css({ "background-color": "#ffffff" });
    }

    var Penalty = $('#txtPenaltyDscptn').val();
    if (Penalty == "" || Penalty == null)
    {
        text += "<BR>" + " \u002A" + " Please Enter Penalty Description.";
        $('#txtPenaltyDscptn').attr('style', 'border:1px solid #d03100 !important;');
        $('#txtPenaltyDscptn').css({ "background-color": "#fff2ee" });
        opt = 1;
    } else
    {
        $('#txtPenaltyDscptn').attr('style', '1px solid #cdcdcd !important;');
        $('#txtPenaltyDscptn').css({ "background-color": "#ffffff" });
    }
    ...
    {
        text += "<BR>" + " \u002A" + " Please Select Block/Taluka From List.";
...
function SubmitData()
{
    ...
    var datavar = {
        'ServiceID': svcid,
        'ProfileID': uid,
        'CertificateType': $('#ddlCertificateType').val(),
        'ApplicantName': $('#txtFullName').val(),
        'FatherName': $('#txtFatherName').val(),
        'MotherName': $('#txtMotherName').val(),
        'Gender': $('#ddlGender').val(),
        'EduQualification': $('#ddlEduQualification').val(),
        'Purpose': $('#ddlPurpose').val(),
        'PenaltyDesc': $('#txtPenaltyDscptn').val(),
        'CourtPunishment': $('#ddlPunishmentType').val(),
    ...
    $.when(
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: '/WebAppUK/EDistrict/CharacterCertificate/CharacterForm.aspx/InsertCharacterCertificateData',
...
function Reset()
{
    ...
    window.location.href = '/WebAppUK/Edistrict/CharacterCertificate/CharacterForm.aspx?SvcID=' + svcid + '&DPT=' + dpt + '&DIST=' + dist + '&BLK=' + blk + '&PAN=' + pan + '&OFC=' + ofc + '&OFR=' + ofr + '&UID=' + uid + '';
}
