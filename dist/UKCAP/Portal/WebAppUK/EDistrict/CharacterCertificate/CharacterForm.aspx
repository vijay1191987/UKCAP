<%@ Page Title="" Language="C#" MasterPageFile="~/WebAppUK/master/UKAdmin.Master" ClientIDMode="Static" AutoEventWireup="true" CodeBehind="CharacterForm.aspx.cs" Inherits="CitizenPortal.WebAppUK.EDistrict.CharacterCertificate.CharacterForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="/WebAppUK/Edistrict/CharacterCertificate/Character.js?v=<%=CitizenPortal.Common.GlobalValues.JSVersion%>"></script>
        ...
        <div class="container-fluid">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> 
                <h2 class="form-heading" style="margin: 15px auto;">
                    <span class="col-lg-9 p0" style="font-family: Arial !important; font-size: 22px;"><i class="fa fa-pencil-square-o fa-fw"></i>CHARACTER CERTIFICATE
                    </span>
            ...
            <div class="col-xs-12 col-sm-8 col-md-9 col-lg-9 pleft0">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 box-container">
                    ...
                    <div class="box-body box-body-open">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-2 col-lg-2 pright0">
                            <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                            <div class="form-group">
                                <label class="manadatory">{{resourcesData.lblEducationQual}}</label>
                                <select class="form-control" id="ddlEduQualification">
                                    <option value="0">-Select-</option>
                                    ...
                                    <option value="Master">Master's/Doctorate</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-5 col-lg-5">
                            <div class="form-group">		
                                ...
                                <label class="manadatory">{{resourcesData.lblPurposeforApply}}</label>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-7 col-lg-7">
                            <div class="form-group">
                                <label class="manadatory">{{resourcesData.lblCourtPunishmentType}}</label>
                                <select class="form-control" id="ddlPunishmentType">
                                    <option value="0">-Select-</option>
                                    <option value="Dummy1">-Dummy Data 1-</option>
                                    <option value="Dummy2">-Dummy Data 2-</option>
                                    <option value="Dummy3">-Dummy Data 3-</option>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-5 col-lg-5">
                            <div class="form-group">
                                <label class="manadatory">{{resourcesData.lblPenaltyDscptn}}</label>
                                <input type="text" id="txtPenaltyDscptn" placeholder="Description" class="form-control" maxlength="20" />
                            </div>
                        </div>
                ...
                <div class="box-body box-body-open">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="txtPincode" class="form-control" placeholder="Pincode" maxlength="6" onkeypress="return isNumber(event);" onchange="PinCodeValidation(this);" />
                        </div>
                    </div>
                    <div class="clearfix">
                    </div>
