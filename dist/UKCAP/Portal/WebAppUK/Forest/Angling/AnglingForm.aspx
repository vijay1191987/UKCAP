<%@ Page Title="" Language="C#" MasterPageFile="~/WebAppUK/master/UKAdmin.Master" ClientIDMode="Static" AutoEventWireup="true" CodeBehind="AnglingForm.aspx.cs" Inherits="CitizenPortal.WebAppUK.Forest.Angling.AnglingForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="/WebAppUK/Forest/Angling/AnglingScript.js?v=<%=CitizenPortal.Common.GlobalValues.JSVersion%>"></script>
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12 p0">
                <h2 class="form-heading" style="width: 98%; margin: 15px auto;">
                    <i class="fa fa-pencil-square-o fa-fw"></i>ANGLING PERMISSION FORM
                </h2>
            </div>
            ...
            <div class="col-lg-12">
                <div class="alert alert-info">
                    <b>Note:</b><br />
                    <br />
                    <span style="line-height: 22px;"><b>Terms & Condition for Applicant</b><br />
                        1. Nots of fish net should not be less than .<br />
                        2. Netting small fish for bait is not permitted.<br />
                        3. The permit should be returned to concerned Forest Officer.<br />
                        4. Forest Rest house should not be used as  camping ground.<br />
                        5. 1 Fishing Rod Rs. 750 - per Person.</span>
                </div>
            </div>
               <div class="clearfix"></div>
            ...
            <div class="col-lg-12 box-container mtop5">
                <div class="box-heading ">
                    <h4 class="box-title manadatory">Area/Division Details</h4>
                </div>
                <div class="box-body box-body-open">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="10" class="form-control" placeholder="DD/MM/YYYY" id="txtFromDate" onkeypress="return false"  />
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            <label class="manadatory">To Date</label>
                            <input type="text" maxlength="10" class="form-control" placeholder="DD/MM/YYYY" id="txtToDate" onkeypress="return false"  />
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="box-body box-body-open">
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="txtFullName" class="form-control" maxlength="50" placeholder="Applicant Full Name" onkeypress=" return ForName(event);" />
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            <label class="manadatory">Father/Husband Name</label>
                            <input type="text" id="txtFatherSpouseName" class="form-control" maxlength="50" placeholder="Father/Husband Name" onkeypress=" return ForName(event);" />
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="txtEmailID" maxlength="40" class="form-control" placeholder="Email ID" onchange="EmailValidation();" />
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            <div class="col-xs-6 p0">
                                <label>Fishing Rods No.</label>
                                <input type="text" id="txtFishingRod" maxlength="2" value="0" class="form-control" placeholder="Fishing Rods" onchange="AnglingFee();" onkeypress="return isNumberKey(event);" />
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="txtAnglingFee" class="form-control" disabled="disabled" placeholder="Total Fee" />
                        </div>
                    </div>
                    <div class="clearfix"></div>
            ...
            <div id="divTrackerDetail" runat="server" style="display: none;">
                <div class="col-md-12 box-container mtop10">
                    <div class="box-heading">
                        <h4 class="box-title">Added User Details</h4>
                    </div>
                    <div class="box-body box-body-open">
                        <div class="col-lg-12">
