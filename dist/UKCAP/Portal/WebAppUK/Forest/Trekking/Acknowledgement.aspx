<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acknowledgement.aspx.cs" Inherits="CitizenPortal.WebAppUK.Forest.Trekking.Acknowledgement" %>
...
<body>
    <form id="form1" runat="server">
         <div style="text-align: center; margin: 10px auto;">
            <input type="button" id="btnSubmit" style="color: #fff; background-color: #337ab7; border-color: #2e6da4; cursor:pointer; border: none; border-radius: 2px; padding: 8px; min-width: 120px;" value="Print" onclick="javascript: CallPrint('divPrint');" />
            <asp:Button ID="btnOutPut" Text="Tracking Permit" style="color: #fff; background-color: #337ab7; cursor:pointer; border-color: #2e6da4; border: none; border-radius: 2px; padding: 8px; min-width: 120px;" OnClick="btnOutPut_Click" runat="server" />
            <%--<asp:Button id="btnHome" style="color: #fff; background-color: #33b768; border-color:#33b768; cursor:pointer; border: none; border-radius: 2px; padding: 8px; min-width: 120px;" Text="Home" onclick="btnHome_Click" runat="server" />--%>
        </div>
        <div id="divPrint">
            <div style="width: 1060px; height: 1150px;  border: 3px solid #000; padding: 1px; font-family: Arial; margin: 0 auto; ">
                <div style="background-image: url('/WebAppUK/img/certificate_logo_bg.png'); background-size: 590px; background-repeat: no-repeat; background-position: center center; width: 1050px; height: 99.5%; border: 1px solid #000; margin: 2px auto;">
                    <table style="width: 100%; font-family: Arial; text-align: center; font-size: 13px;">
                        <tbody>
                            <tr>
                                ...
                                <td style="font-size: 24px; padding-top: 10px; font-weight:bold; text-align:center;">TREKKING ENTRANCE ACKNOWLEDGEMENT<span style="display:none; font-size:14px; font-weight:normal;">TREKKING ENTRANCE </span></td>
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 99%; font-size: 12px; line-height: 18px; border: 0; margin: 0 auto;">
                        <tbody>
                            <tr>
                                <td style="padding: 12px 5px; border: 1px solid #999; text-align: left; font-size: 14px; font-weight: bold; background-color: #383E4B; color: #fff; -webkit-print-color-adjust: exact;" colspan="4">Tracking Booked By</td>
                            </tr>
                            <tr>
                    ...
                    <br />
                    <table cellpadding="0" cellspacing="0" style="width: 99%; line-height:18px; border: none; margin: 0 auto;">
                            <tr>
                                <td style="padding: 12px 5px; border: 1px solid #999; text-align: left; font-size: 14px; line-height: 18px; font-weight: bold; background-color: #383E4B; color: #fff; -webkit-print-color-adjust: exact;" colspan="4">Trackers Details</td>
                            </tr>
                    </table>
                    <asp:GridView ID="GridTrackerDetail" runat="server" CellPadding="5" ShowHeaderWhenEmpty="true" CssClass="table table-striped table-bordered" Style="margin: 0 auto;" ClientIDMode="Static" Width="99%" BorderStyle="Solid" Font-Strikeout="False">
                        <HeaderStyle BackColor="#CCCCCC" Font-Size="11px" ForeColor="Black" />
                        <RowStyle Font-Size="12px" />
                    </asp:GridView>
                    <br />
                    <table cellpadding="0" cellspacing="0" style="width: 99%; font-size: 12px; line-height:18px; margin: 0 auto;">
                        <tr>
