...
<script language="C#" runat="server">    
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //		Request.Form["AppID"]	"123456"	string
        //		Request.Form["AppID"]	"123456"	string
        //		Request.Form["AppID"]	"123456"	string

        string KioskID = Request.Form["KioskID"];
        string AppID = Request.Form["AppID"];

        FilesPath = Path.Combine(FilesPath, "Uploads", AppID);
        ...
        else if (Request.HttpMethod.ToUpper() == HttpMethods.POST)
        {
            ...
            for (int FileIndex = 0; FileIndex < Request.Files.Count; FileIndex++)
            {
                ...
                string NewFileName = Request.Form["FileName"];
                uniqueFileName = NewFileName + ext;
