<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/Vendor.Master" AutoEventWireup="true" CodeBehind="RequestForPay.aspx.cs" Inherits="CitizenPortal.PG.RequestForPay" %>
   ...
   protected void Page_PreInit(Object sender, EventArgs e)
    ...
    protected void PaymentICICI(object sender, EventArgs e)
    {
        ...
        if (PG_Status == "PG006")
        {
            ...
            string url = t_URL + "?SvcID=" + SVCID + "&TransID=" + REFNO + "&Status=" + PGStatus;
    ...
    protected void PaymentKOTAK(object sender, EventArgs e)
    {
        divhide.Visible = false;
        divkotak.Visible = true;
        lblkotak.Visible = true;
        lblkotak.Text = "Under Processing";
    }
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 ...
 <link href="../g2c/css/style.css" rel="stylesheet" />
    <link href="../g2c/css/hmepge.bootstrap.css" rel="stylesheet" />
     <style>
        #cphbody_lblsms , #cphbody_lblkotak{
            text-align: center;
            position: absolute;
            bottom: 2px;
            color: red;
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphbody" runat="server">
    <div class="row mbtm10" id="divhide" runat="server">
              ...
              <div class="pymntbox_subhd">
                  <div class="col-xs-10 ptop10"><p style="font-size: 20px !important; padding-top: 10px; padding-left: 0;">Debit / Credit Card</p></div>
                  ...
                  <div class="col-xs-2 ptop15">
                      ...
                      <div class="w98">
                          ...
                          <div id="DIVPayment" runat="server" class="col-md-8 bnklstbox pymntbox_bdr2 mtop20 mbtm20">
                              <div class="col-lg-12" style="border: 2px solid #ddd; box-shadow: 1px 1px 5px #dbdbdb; padding: 12px; margin-top:12px;">
                              ...
                              <div class="col-xs-9 ptop10" style="color:#212121;">
                                  Debit Card - (Below INR 2000/-) - 0.75% Processing Fee, <br />(Above INR 2000/-) - 1.00% Processing Fee<br />
...
Credit Card - 1.05% Processing Fee
    ...
    <div id="divkotak" runat="server" class="col-xs-10 ptop10" style="margin-bottom:30px;">
        <p style="font-size: 30px !important; padding-top: 40px;  text-align:center; padding-left: 0;" >
        <asp:Label id="lblkotak" runat="server"></asp:Label>
        </p>
    </div>
        </div>
