<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="Migration.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.DTE.Migration" %>
                        ...
                        <div class="box-body box-body-open">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input id="txtRegistration" class="form-control" placeholder="Registration Number as a student of State Council" name=" txtRegistration" type="text" value="" maxlength="20"
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="txtDetails" style="display:none;" class="form-control" placeholder="Details of Examination passed/appreared" name=" txtDetails" type="text" value=""
                                        autofocus />
                                </div>
                            </div>
