<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinancingAcknowledgement1.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.DTE.FinancingAcknowledgement1" %>
...
<head runat="server">
    <title>Students Acknowledgement : Financial Assistance (Guardian’s Death Category)</title>
                    ...
                    <div style="margin: 0 auto; height: auto; width: 100%; border: 3px solid #000; padding: 1px; font-family: Arial;">
                        <div style="margin: 0 auto; width: 785px; border: 1px solid #000; background-image: url('../images/bgLogo.png'); background-image: url('../images/bgLogo.png'); background-size: 590px; background-repeat: no-repeat; background-position: center center;">
                            ...
                            <div style="text-align: center; font-size: 20px; font-weight: bolder; padding: 5px; text-transform: uppercase; background-color: #808080; color: #fff;">
                                <asp:Label runat="server" ID="lblCertificateName" Style="font-size: 20px; font-weight: bolder; text-transform: uppercase;">Financing Assistance To The Students For Continuing Study</asp:Label>
                                <br />
                                <span id="lblDeptName" runat="server" style="font-size: 15px">(if the financing guardian expired)
                                </span>
                            </div>
                            ...
                            <div style="margin: 10px auto; width: 708px; font-size: 13px;">
                                ...
                                <table style="width: 100%; border: 0;" cellpadding="5" cellspacing="0" class="table-bordered">
                                    ...
                                    <tr>
                                        <td width="24%" style="border: 1px solid #999; padding: 5px; text-align: left; width: 25%;">Registration Number</td>
                                        ...
                                        <td width="25%" style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Year of Admission</td>
                                    ...
                                    <tr>
                                        <td style="padding: 5px; text-align: left; border: 1px solid #999;">Semester</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left;">
                                            <asp:Label ID="lblSemester" runat="server" Font-Size="15px"></asp:Label>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left;">Type of Institute</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left;">
                                            <asp:Label ID="lblInstituteType" runat="server" Font-Size="15px"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; text-align: left; border: 1px solid #999;">Name of Instituition</td>
                                    ...
                                    <tr>
                                        <td style="padding: 5px; text-align: left; border: 1px solid #999;">Branch</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left;">
                                            <asp:Label ID="lblBranch" runat="server" Font-Size="15px"></asp:Label></td>
                                ...
                                <table style="width: 100%; border: 0;" cellpadding="5" cellspacing="0" class="table-bordered">
                                    ...
                                    <tr>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">DOD of Financing Guardian</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="lblDODFinancingGuardian" runat="server"></asp:Label>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Annual Income</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="lblannualincome" runat="server" Font-Size="15px"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                                <table style="width: 100%; border: 0;" cellpadding="5" cellspacing="0" class="table-bordered">
                                    <tr>
                                        <td colspan="4" style="border-left: 1px solid #999; border-right: 1px solid #999; border-top: 1px solid #999; border-bottom: 1px none #999; padding: 5px; text-align: left;"><b>Amount Claimed Components Wise</b></td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Tuition Fee</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="lblTuitionFee" runat="server"></asp:Label>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Development Fee</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="lblDevelopmentFee" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Examination Fee</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="lblExaminationFee" runat="server"></asp:Label>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Books</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="lblBooks" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Study Material</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="lblStudyMaterial" runat="server"></asp:Label>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Conveyance</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="lblConveyance" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Km</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="drpKiloMeter" runat="server"></asp:Label>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Total Fee Amount</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="txtTotalAmt" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                                <table style="width: 100%; border: 0;" cellpadding="5" cellspacing="0" class="table-bordered">
                                    <tr>
                                        <td colspan="4" style="border-left: 1px solid #999; border-right: 1px solid #999; border-top: 1px solid #999; border-bottom: 1px none #999; padding: 5px; text-align: left;"><b>Hostel Charges for Govt. Institute</b></td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Hostel Rent &amp; Electricity</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="lblGovHostelCharges" runat="server"></asp:Label>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Contingency &amp; Development Fee</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="lblGovHostelDevFee" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4" style="padding: 5px; border: 1px solid #999; text-align: left;"><b>Hostel Charges for Private Institute</b></td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Own/Rented</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="lblPriHostelType" runat="server"></asp:Label></td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Annual Amount (Rs.) p.a</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="lblPriHostelDevFee" runat="server"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td colspan="4" style="padding: 5px; border: 1px solid #999; text-align: left;"><b>Additional Benefits Details</b></td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Benefits Amount Received</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="lblPrerenaScheme" runat="server"></asp:Label></td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Tuition Fee Waiver</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="lblTuitionFeeWaiver" runat="server"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">Student Type</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">
                                            <asp:Label ID="lblStudentType" runat="server"></asp:Label></td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">&nbsp;</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 25%;">&nbsp;</td>
                                    </tr>
                                </table>
                                <br />
                                ...
                                <table style="width: 100%; border: 0;" cellpadding="5" cellspacing="0" class="table-bordered">
                                    <tr>
                                        <td style="border-left: 1px solid #999; border-right: 1px solid #999; border-top: 1px solid #999; border-bottom: 1px none #999; padding: 5px; text-align: left;" colspan="4"><b>Issuer Details Of Death Certificate</b></td>
                                    </tr>
                                    <tr>
                                ...
                                <asp:GridView ID="grdView" runat="server" CellPadding="5" ShowHeaderWhenEmpty="true" CssClass="table table-striped table-bordered" Style="margin-bottom: 0;" ClientIDMode="Static" Width="100%"></asp:GridView>
                                <br />
                                <table cellpadding="5" cellspacing="0" class="table-bordered" style="width: 100%; border: 0;">
                                    <tr>
