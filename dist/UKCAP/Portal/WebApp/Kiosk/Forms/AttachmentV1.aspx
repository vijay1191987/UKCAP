<%@ Page Title="" Language="C#" MasterPageFile="~/WebAppUK/master/UKAdmin.Master" AutoEventWireup="true" CodeBehind="AttachmentV1.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.Forms.AttachmentV1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        //{           
        //    alert(id.offsetParent.parentNode.rowIndex);
        //    $('#ContentPlaceHolder1_HFGVRowId').val(id.offsetParent.parentNode.rowIndex);
        //}
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="HFServiceID" runat="server" Value="997" />
     <asp:HiddenField ID="HFGVRowId" runat="server" />
</asp:Content>
