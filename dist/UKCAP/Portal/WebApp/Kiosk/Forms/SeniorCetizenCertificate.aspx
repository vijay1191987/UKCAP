<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeniorCetizenCertificate.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.Forms.SeniorCetizenCertificate" %>
...
<body>
    <form id="form1" runat="server">
        <div id="page-wrapper" class="box-container" style="min-height: 500px !important; width: 500px; margin: 50px auto;">
            <%---Start of Application Details----%>
            <div class="row">
                <div class="col-md-12 box-container mTop15">
                    <div class="box-heading">
                        <h4 class="box-title">{{resourcesData.lblSenCertOut}}
                        </h4>
                    </div>
