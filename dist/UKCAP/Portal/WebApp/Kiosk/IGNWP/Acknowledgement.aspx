<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acknowledgement.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.IGNWP.Acknowledgement" %>
            ...
            <div class="box-body box-body-open">
                <asp:Panel ID="divPrint" runat="server" Style="margin: 0 auto; width: 800px; /*height: 1220px; overflow: auto; */">
                    <div style="margin: 0 auto; height: 1141px; width: 794px; border: 3px solid #000; padding: 1px; font-family: Arial">
                        <div style="margin: 3px auto; height: 1132px; width: 785px; border: 1px solid #000; background-image: url('../images/bgLogo.png'); background-image: url('../images/bgLogo.png'); background-size: 590px; background-repeat: no-repeat; background-position: center center;">
                            ...
                            <div style="text-align: center; font-size: 20px; font-weight: bolder; padding: 5px; text-transform: uppercase; background-color: #808080; color: #fff;">
                                <asp:Label ID="lblCertificateName" runat="server" CssClass="lbl_value" Text="Indira Gandhi National Widow Pension Scheme(IGNWP)"></asp:Label>
                                <br />
                                    ...
                                    <td style="vertical-align: top; height: 924px;">
                                        <div style="margin: 10px auto; width: 708px; font-size: 13px;">
                                            <table cellpadding="5" cellspacing="0" class="table-bordered" style="width: 100%; border: 0;">
                                                ...
                                                <tr>
                                                    <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 135px;">
                                                        <asp:Label ID="lblIncome0" runat="server">Deceased Full Name</asp:Label>
                                                    </td>
                                                    <td colspan="3" style="padding: 5px; border: 1px solid #999; text-align: left;">
                                                        <asp:Label ID="lblDeasesed" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 135px;">
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%" style="display: none;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; border: 1px solid #999; border-bottom: none; border-right: none; white-space: nowrap;">Death Certificate </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px; border: 1px solid #999; border-bottom: none; border-right: none; white-space: nowrap;">Beneficiary Voter ID</td>
                                                    <td style="padding: 5px; border: 1px solid #999; text-align: center; border-bottom: none;"><a>Attached</a></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 5px; border: 1px solid #999; text-align: center; border-bottom: none; border-right: none;">3.</td>
                                                    <td style="padding: 5px; border: 1px solid #999; border-bottom: none; border-right: none; white-space: nowrap;">Beneficiary BPL Card </td>
                                                    <td style="padding: 5px; border: 1px solid #999; text-align: center; border-bottom: none;">&nbsp;<a>Attached</a></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 5px; border: 1px solid #999; text-align: center; border-bottom: 1px solid #999; border-right: none;">4.</td>
                                                    <td style="padding: 5px; border: 1px solid #999; border-bottom: 1px solid #999; border-right: none; white-space: nowrap;">Income Certificate</td>
