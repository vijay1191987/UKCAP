<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Preview.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.Death.Preview" %>
                    ...
                    <div style="margin: 0 auto; height: 1191px; width: 794px; border: 3px solid #000; padding: 1px;">
                        ...
                        “ब”, अर्ज “थ”
                            ...
                            <div style="margin: 30px auto; width: 708px; font-size: 13px;">
                                ...
                                <div style="float: left; height: 30px; width: 130px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                    Mobile No.<span style="color: #F00">*</span>
                                </div>
                                <div style="float: left; height: 30px; width: 134px; border-bottom: 1px solid #999; margin: 0; padding: 5px 0 0 7px;">
                                    <asp:Label ID="lblMobile" runat="server"></asp:Label>
                                </div>
                                <div style="float: right; height: 170px; width: 140px; border: 1px solid #999; border-top: none; padding: 0;">
                                    <asp:Image ID="Image3" runat="server" Height="170px" Width="140px" ImageAlign="Right" ImageUrl="~/WebApp/Kiosk/Images/photo.png" />
                                </div>
                                <div style="float: left; height: 30px; width: 100px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                    Applicant Name <span style="color: #F00">*</span>
                                </div>
                                <div style="float: left; height: 30px; width: 170px; border-bottom: 1px solid #999; margin: 0; padding: 5px 0 0 7px;">
                                ...
                                <div style="float: left; height: 27px; width: 100px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                ...
                                <div style="float: left; height: 27px; width: 130px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                    Gender<span style="color: #F00">*</span>
                                </div>
                                <div style="float: left; height: 30px; width: 134px; border-bottom: 1px solid #999; margin: 0; padding: 2px 0 0 7px;">
                                    <asp:Label ID="lblGender" runat="server"></asp:Label>
                                </div>
                                <div style="float: left; height: 27px; width: 100px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                    Date of Death <span style="color: #F00">*</span>
                                </div>
                                <div style="float: left; height: 30px; width: 170px; border-bottom: 1px solid #999; margin: 0; padding: 2px 0 0 7px;">
                                    <asp:Label ID="lblDOD" runat="server"></asp:Label>
                                </div>
                                <div style="float: left; height: 27px; width: 130px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                    Time of Death <span style="color: #F00">*</span>
                                </div>
                                <div style="float: left; height: 30px; width: 134px; border-bottom: 1px solid #999; margin: 0; padding: 2px 0 0 7px;">
                                    <asp:Label ID="lblDOT" runat="server"></asp:Label>
                                </div>
                                <div class="" style="float: left; height: 27px; width: 100px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                    Date of Birth <span style="color: #F00">*</span>
                                </div>
                                <div style="float: left; height: 30px; width: 170px; border-bottom: 1px solid #999; margin: 0; padding: 2px 0 0 7px;">
                                    <asp:Label ID="lblDOB" runat="server" Text="22/08/2016"></asp:Label>
                                </div>
                                <div class="" style="float: left; height: 27px; width: 130px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                    Place of Birth <span style="color: #F00">*</span>
                                </div>
                                <div style="float: left; height: 30px; width: 134px; border-bottom: 1px solid #999; margin: 0; padding: 2px 0 0 7px;">
                                    <asp:Label ID="lblPOB" runat="server" Text="22/08/2016"></asp:Label>
                                </div>
                                <div style="clear: both; margin: 0; line-height: 0; padding: 0;">
                                </div>
                                ...
                                <div class=" " style="float: right; height: 25px; width: 541px; border: 1px solid #999; padding: 6px 0 0 7px; border-top: none; border-left: none; height: 145px;">
                                ...
                                <div class=" " style="float: left; height: 30px; width: 150px; border: 1px solid #999; padding: 6px 0 0 7px; border-top: none; height: 145px;">
                                    Death Place Address <span style="color: #F00">*</span>
                                    <br />
                                    <ul style="margin: 4px 0 0 -25px; line-height: 19px;">
                                ...
                                <div class=" " style="float: right; height: 25px; width: 541px; border: 1px solid #999; padding: 6px 0 0 7px; border-top: none; border-left: none; height: 145px;">
                                    <div style="height: 80px;">
                                        ...
                                        <asp:Label ID="Label2" runat="server" Font-Size="15px"></asp:Label>
                                        <asp:Label ID="Label3" runat="server" Font-Size="15px"></asp:Label>
                                        <asp:Label ID="Label4" runat="server" Font-Size="15px"></asp:Label>
                                    </div>
                                    <div style="height: 30px; border: 1px solid #999; border-left: none; border-right: 0; margin-left: -7px;">
                                        <div style="float: left; width: 60px; border-right: 1px solid #999; height: 28px; background-color: #f3aba4; padding: 5px 0 0 7px;">
                                            Village
                                        ...
                                        <div style="float: left; width: 190px; height: 28px; padding: 5px 0 0 7px;">
                                            <asp:Label ID="Label7" runat="server" Font-Size="15px"></asp:Label>
                                        </div>
                                    </div>
                                    <div style="clear: both; margin: 0; line-height: 0; padding: 0;">
                                    </div>
                                    ...
                                    <div style="float: left; width: 190px; border-right: 1px solid #999; height: 28px; padding: 5px 0 0 7px;">
                                        <asp:Label ID="Label8" runat="server" Font-Size="15px"></asp:Label>
                                    </div>
                                    <div style="float: left; width: 60px; height: 28px; padding: 5px 0 0 7px; border-right: 1px solid #999; background-color: #f3aba4;">
                                        PIN
                                    </div>
                                    <div style="float: left; width: 190px; height: 28px; padding: 5px 0 0 7px;">
                                        <asp:Label ID="Label9" runat="server" Font-Size="15px"></asp:Label>
                                    </div>
                                </div>
                                <div style="clear: both; margin: 0; line-height: 0; padding: 0;">
                                </div>
