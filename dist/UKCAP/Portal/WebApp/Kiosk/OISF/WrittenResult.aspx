<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/HomeMaster.Master" AutoEventWireup="true" CodeBehind="WrittenResult.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.OISF.WrittenResult" %>
            ...
            <div id="page-wrapper" style="min-height: 311px; width: 80%;">
                ...
                <div class="clearfix">
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i>
                        Written Examination Result of 9th SIRB - 2016
                    </h2>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 box-container">
                                <div class="box-heading">
                                    <h4 class="box-title">Written Result Details 
                                    </h4>
                                </div>
                                <div class="box-body box-body-open" style="display:none">
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox runat="server" ID="txtDateFrom" CssClass="form-control" placeholder="DD/MM/YYYY" name="txtDateFrom" value="" MaxLength="10"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <label class="manadatory" for="DOB">Date To </label>
                                            <asp:TextBox runat="server" ID="txtDateTo" CssClass="form-control" placeholder="DD/MM/YYYY" name="txtDateTo" value="" MaxLength="10"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                                        <div class="form-group">
