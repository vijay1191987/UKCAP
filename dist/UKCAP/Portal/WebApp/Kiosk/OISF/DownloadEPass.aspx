<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/HomeMaster.Master" AutoEventWireup="true" CodeBehind="DownloadEPass.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.OISF.DownloadEPass" %>
            ...
            <div id="page-wrapper" style="min-height: 311px;width:80%;margin:0 auto;">
                ...
                <div class="clearfix">
                    ...
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i>
                        Download E-Pass Recruitment of Constables in 9TH SIRB
                    </h2>
                </div>
                <div class="row" id="divCitizenProfile">
                    <div id="" class="col-md-12">
                        <div runat="server" class="success" id="div1">
                             <b style="text-transform:uppercase;">Announcment of Physical Measurment and Physical Efficiency Examination Date</b><br />
                                13th Batch Examination Date <b> Sunday 26th February 2017,</b> for Roll No. <b>ST02181</b> to <b>ST08728</b><br />
                            14th Batch Examination Date <b> Tuesday 28th February 2017,</b> for Roll No. <b>ST08729</b> to <b>ST15276</b><br />
                            15th Batch Examination Date <b> Thrusday 2nd March 2017,</b> for Roll No. <b>ST15277</b> to <b>ST21823</b><br />
                            16th Batch Examination Date <b> Saturday 4th March 2017,</b> for applicant who has filled Grievance<br />
...
Call Centre at 06746580111/6580222/6580333, Shri.Naba Das (+91 8895856633), Shri.Narayana Dora (+91 9437905270).</b>--%>
                        ...
                        <div runat="server" class="danger error bg-warning" id="divErr">
                            Please enter Date of Birth, Mobile Number (Mandatory) and any one of Roll Number or Reference ID or Login ID fields to download E-Pass.
                        </div>
                        <div class="row">
