<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/HomeMaster.Master" AutoEventWireup="true" CodeBehind="ScoreSheet.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.OISF.ScoreSheet" %>
            ...
            <div id="page-wrapper" style="min-height: 311px;width:80%;margin:0 auto;">
                ...
                <div class="clearfix">
                    ...
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i>
                        Score Sheet for Recruitment of Constables in 9TH SIRB
                    </h2>
                </div>
                <div class="row" id="divCitizenProfile">
                    <div id="" class="col-md-12">
                        ...
                        <div runat="server" class="danger error bg-warning" id="divErr">
                            Please enter Date of Birth, Mobile Number (Mandatory) and any one of Roll Number or Reference ID or Login ID fields to download Mark Sheet.
                        </div>
                        <div class="row">
