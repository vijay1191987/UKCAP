<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="OISFForm.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.OISF.OISFForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        //show hide div on radio button click
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ClientIDMode="Static">
        ...
        <div id="divCitizenProfile">
            <div>
                <h2 class="form-heading">
                    <i class="fa fa-pencil-square-o"></i>Application Form for Recruitment for Constables in 9<sup>th</sup> India Reserve Batalion (Specialised)
                    <span class="pull-right" style="font-style: normal; font-size: 12px; text-align: right; padding: 0;">
                        <i class="fa fa-info-circle" style="cursor: pointer; font-size: 22px; color: #777;" title="Information" onclick="ckhInfo();"></i></span>
                </h2>
            </div>
            ...
            <div class="mt20">
                    ...
                    <div class="row">
                        <div class="col-md-12 box-container">
                            <div class="box-heading">
                                <h4 class="box-title">Fill your profile using Aadhaar
                                </h4>
                            </div>
                            ...
                            <div class="box-body box-body-open">
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-4 pright0">
                                            <div class="col-xs-4  pleft0 pright0" style="padding-top: 8px;">
                                                <label class="manadatory" for="aadhaarno">
                                                    Aadhaar No.</label>
                                            </div>
                                            <div class="col-xs-8 pleft0 pright0">
                ...
                <asp:Button ID="Button1" runat="server" CausesValidation="False" CssClass="btn btn-primary"
                    Text="Bio metric" OnClientClick="return openWindow(1,1,'UIDSGNPPass'); " />--%>
                        ...
                        <div id="" class="col-md-3 box-container mTop15 pleft0">
                            <div id="divPhoto" class="col-md-12 box-container">
                                <div class="box-heading">
                                    <h4 class="box-title">Applicant Photograph
                                    </h4>
                                </div>
                            ...
                            <div id="divSign" class="col-md-12 box-container">
                                <div class="box-heading">
                                    <h4 class="box-title">Applicant Signature
                                    </h4>
                                </div>
                                <div class="box-body box-body-open" style="padding-bottom: 0;">
                                    <div class="col-lg-12">
                                        <img class="form-control" src="/webApp/kiosk/Images/photo.png" name="signaturecustomer" style="height: 220px" id="mySign" />
                        ...
                        <div id="" class="col-md-9 box-container mTop15 pleft0">
                            <div id="divDetails" class="col-md-12 box-container mTop15">
                                ...
                                <div class="box-body box-body-open">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                        <div class="form-group">
                                            <label class="manadatory" for="DOB">
                                                Date of Birth <span style="font-size: 10px;">(As per HSC Certificate)</span></label>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12" style="display: none">
                                        <div class="form-group">
                                            <div class="col-xs-6">
                                                <input id="othrrlgon" class="form-control" placeholder="Height in cm" name="othrrlgon" value="" maxlength="6" onkeypress="return isNumberKey(event);" autofocus="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="form-group">
                                    <table style="width: 100%" class="table table-striped table-bordered">
                                        <tbody>
                                            <tr>
                                                <th style="text-align: center; width: 18%;">State</th>
                                            ...
                                            <tr>
                                                ...
                                                <td style="">
                                                    <input id="txtPssngYr" class="form-control" placeholder="YYYY" name="txtPssngYr" type="text" value="" autofocus="" maxlength="10" />
                                                </td>
                                                <td style="">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12 othrinfohd">
                                        <div class="col-md-9 pleft0">
                                            <p><b class="dplyflex"><span class="fom-Numbx">1.</span> Has the Candidate passed Odia as one of the subject in HSC Examination or an examination in Odia language equivalent to M.E. Standard recognised or conducted by the School and Mass Education Department of Odisha. (photo copy with self attestation should be enclosed)</b></p>
                                        </div>
  ...
  <label for="checkbox"></label>
                                ...
                                <div class="form-group mtop5">
                                    <div class="col-lg-12 othrinfohd">
                                        <div class="col-md-9 pleft0">
                                            <p><b class="dplyflex"><span class="fom-Numbx">5.</span> If Sports Person (candidate only indicate one sports event participatedin Open National Championship / International Championship and the same should be recognised and sponsored either by the recognised National Sports Federations / Associations or Indian Olympic Association, Odisha State Sports Association, Affiliated to the recognised National Sports Federation / Association)</b></p>
                                        </div>

                                        <div class="col-md-3 pleft0 pright0">
                                            <div class="col-xs-6 pleft0">
                                                <input type="radio" name="radio4c" id="plyntnalyes" value="played national or international" onclick="return fuShowHideDiv('plyntnl', 1);" />
                                                Yes
                                            <label for="plyntnalyes"></label>

                                            </div>
                                            <div class="col-xs-6">
                                                <input type="radio" name="radio4c" id="plyntnalno" value="Not played national or international" onclick="return fuShowHideDiv('plyntnl', 0);" />
                                                No
                                            <label for="plyntnalno"></label>
                                ...
                                <div class="form-group mtop5">
                                    <div class="col-lg-12 othrinfohd">
                                        <div class="col-md-9 pleft0">
                                            <p><b class="dplyflex"><span class="fom-Numbx">8.</span> Whether the candidate possess a Driving licenses having the validity for at least 1 year (Excluding the learning period) ?</b></p>
                                        </div>
                                        <div class="col-md-3 pleft0 pright0">
                                            <div class="col-xs-6 pleft0">
                                ...
                                <div id="hvngcrmnlcse">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-12 othrinfosubhd2">
                                            ...
                                            <div class="col-md-3 pleft0 pright0">
                                                <div class="col-xs-12 pright0 pleft0">
                                                    <select class="form-control" data-val="true" data-val-number="Religion" data-val-required="Please select your Category" id="txtPoliceStationNo" name="txtPlcestonNo">
                                                        <option value="Select Category">Select</option>
                        ...
                        <uc1:OISFDeclaration runat="server" ID="OISFDeclaration" ClientIDMode="Static" />
