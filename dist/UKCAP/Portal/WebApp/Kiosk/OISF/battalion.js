function openWindow(UIDVal, value, SessionName) {
    ...
    if (validateUID(UIDVal) != false) {
        ...
        window.open('/UID/Default.aspx?SvcID=395&aadhaarNumber=' + UID + '&kycTypesToUse=OTP', 'open_window',
...
function ValidateForm() {
    ...
    /// Basic Information 
    //------------------------------------------------------------
    var ddlBattalion = $("#ddlBattalion");

    


    var Issuedate1 = $("#Issuedate");
    var FormNumber = $("#FormNumber");
    var DDNumber = $("#DDNumber");
    //-----------------------------------------------------------
    ...
    //Section 9 battelian detail
    var DDissuebankname = $("#txtissuebanknameof200rs");
    var DDnumber = $("#txtsecddno");
    var Issuedate = $("#IssueDateOd200Rs");
    ...
    if (ddlBattalion.val() == '' || ddlBattalion.val() == '0' || ddlBattalion.val() == 'Select Battalion/District') {
        text += "<br /> -Please select Battalion Name.";
        $('#ddlBattalion').attr('style', 'border:1px solid #d03100 !important;');
        $('#ddlBattalion').css({ "background-color": "#fff2ee" });
        opt = 1;
    } else {
        $('#ddlBattalion').attr('style', 'border:1px solid #cdcdcd !important;');
        $('#ddlBattalion').css({ "background-color": "#ffffff" });
    }
    
    if (Issuedate1.val() == '' || Issuedate1.val() == null) {
        text += "<br /> -Please enter Form Number. ";
        Issuedate1.attr('style', 'border:1px solid #d03100 !important;');
        Issuedate1.css({ "background-color": "#fff2ee" });
        opt = 1;
    }
    else {
        Issuedate1.attr('style', '1px solid #cdcdcd !important;');
        Issuedate1.css({ "background-color": "#ffffff" });
    }
    //

    if (FormNumber.val() == '' || FormNumber.val() == null) {
        text += "<br /> -Please enter Form Number. ";
        FormNumber.attr('style', 'border:1px solid #d03100 !important;');
        FormNumber.css({ "background-color": "#fff2ee" });
        opt = 1;
    }
    else {
        FormNumber.attr('style', '1px solid #cdcdcd !important;');
        FormNumber.css({ "background-color": "#ffffff" });
    }

    if (DDNumber.val() == '' || DDNumber.val() == null) {
        text += "<br /> -Please enter DD Number. ";
        DDNumber.attr('style', 'border:1px solid #d03100 !important;');
        DDNumber.css({ "background-color": "#fff2ee" });
        opt = 1;
    }
    else {
        DDNumber.attr('style', '1px solid #cdcdcd !important;');
        DDNumber.css({ "background-color": "#ffffff" });
    }
    ...
    //SECTION 9
    if (Category == "SEBC" || Category == "UR") {
        if (DDissuebankname.val() == '' || DDissuebankname.val() == null) {
            text += "<br /> -Please Enter DD Issue Bank Name ";
            DDissuebankname.attr('style', 'border:1px solid #d03100 !important;');
            DDissuebankname.css({ "background-color": "#fff2ee" });
            opt = 1;
        }
        else {
            DDissuebankname.attr('style', '1px solid #cdcdcd !important;');
            DDissuebankname.css({ "background-color": "#ffffff" });
        }
        ...
        if (Issuedate.val() == '' || Issuedate.val() == null) {
            text += "<br /> -Please Enter Issue Date";
            Issuedate.attr('style', 'border:1px solid #d03100 !important;');
            Issuedate.css({ "background-color": "#fff2ee" });
            opt = 1;
        }
        else {
            Issuedate.attr('style', '1px solid #cdcdcd !important;');
            Issuedate.css({ "background-color": "#ffffff" });
        }
...
function AssignDataValues(JSONData) {
    ...
    //--------------------------------------------------
    $("#ddlBattalion").val(obj["ddlBattalion"]);
    $("#Issuedate").val(obj["Issuedate"]);
    $("#FormNumber").val(obj["FormNumber"]);
    $("#DDNumber").val(obj["DDNumber"]);

    $("#txtissuebanknameof200rs").val(obj["txtissuebanknameof200rs"]);
    $("#IssueDateOd200Rs").val(obj["IssueDateOd200Rs"]);
    $("#txtsecddno").val(obj["txtsecddno"]);
    $("#txtamount").val(obj["txtamount"]);
    //-------------------------------------
...
function GetEducationBoard(StateCode, EdBoard) {
    EddlBoardState = $("#EddlBoardState").val();
    debugger;
    var SelIndex = EddlBoardState;
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: '/WebApp/Kiosk/OISF/battalionForm.aspx/GetEducationBoard',
        data: '{"prefix":"' + category + '","StateCode":"' + SelIndex + '"}',
        processData: false,
        dataType: "json",
        success: function (response) {
...
function GetEmploymentExchange(StateCode, EdBoard) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: '/WebApp/Kiosk/OISF/battalionForm.aspx/GetEmploymentExchange',
...
function GetRTOList(DistrictCode, RTO) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: '/WebApp/Kiosk/OISF/battalionForm.aspx/GetRTOList',
...
function GetPoliceStation(StateCode, DistrictCode, PoliceStation) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: '/WebApp/Kiosk/OISF/battalionForm.aspx/GetPoliceStation',
...
function SubmitData() {
    ...
    //---------------------------------------------------
    var ddlBattalion = $("#ddlBattalion  option:selected").text();
    var Issuedate = $("#Issuedate");
    var FormNumber = $("#FormNumber");
    var DDNumber = $("#DDNumber");

    var IssueBankName = $("#txtissuebanknameof200rs");
    var IssueDateOd200Rs = $("#IssueDateOd200Rs");
    var IssueDDNumber = $("#txtsecddno");
    ...
    var datavar = {
        ...
        //--start implement code--
        'BattalionName':ddlBattalion,
        'Issuedate': $('#Issuedate').val(),
        'FormNumber': $('#FormNumber').val(),
        'DDNumber': $('#DDNumber').val(),

        'IssueBankName': $('#txtissuebanknameof200rs').val(),
        'IssueDDNumber': $('#txtsecddno').val(),
        'IssueDateOd200Rs': $('#IssueDateOd200Rs').val(),
    ...
    $.when(
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: '/WebApp/Kiosk/OISF/battalionForm.aspx/InsertData',
            ...
            if (result /*&& jqXHRData_IMG_result*/) {
                ...
                window.location.href = '/WebApp/Kiosk/OISF/ProcessBar_OISF.aspx?SvcID=395&AppID=' + obj.AppID;
            }
            else {
                $("#progressbar").hide();
