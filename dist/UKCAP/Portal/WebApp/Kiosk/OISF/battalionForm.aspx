<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" CodeBehind="battalionForm.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.OISF.battalion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="/WebApp/Kiosk/OISF/battalion.js?v=<%=CitizenPortal.Common.GlobalValues.JSVersion%>"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ClientIDMode="Static">
            ...
            <div id="page-wrapper" style="min-height: 311px;">
                ...
                <div class="row" id="divCitizenProfile">
                    ...
                    <div>
                        ...
                        <%--Instructions div end here --%>

                        <div class="row">

                            <div id="" class="col-lg-9 p0">
                                <%-- ---start change-----%>
                                <div id="divDetails5" class="col-md-12 box-container">
                                    <div class="box-heading" id="div5">
                                        <h4 class="box-title">{{resourcesData.battalionditails}}

                                        </h4>
                                    </div>
                                    <div class="box-body box-body-open" style="height: 175px;">

                                        <%--//testcode--%>
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <label class="manadatory" for="BattalionName">{{resourcesData.txtissuedfrombattalion}}</label>

                                                <select name="ddlBattalion" id="ddlBattalion" class="form-control" data-val="true" data-val-number="Battalion." data-val-required="Please select Battalion." autofocus="">
                                                    <option value="0">Select Battalion/District</option>
                                                </select>
                                                <%--                                                <input id="BattalionName" class="form-control inputbox_bluebdr" placeholder="Issue From Battalion" name="FirstName" onchange="return checkLength(this);" onkeypress="return ValidateAlpha(event);" type="text" autofocus="" maxlength="20" />--%>
                                            </div>
                                        </div>
                                        <%-- ------%>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <label class="manadatory" for="Issuedate">
                                                    {{resourcesData.issuedate}}</label>
                                                <input id="Issuedate" class="form-control inputbox_bluebdr" placeholder="Issue Date" name="Issuedate" value="" autofocus="" onkeypress="return ValidateAlpha(event);" onkeydown=" return allowBackspace(event);" maxlength="12" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <label class="manadatory" for="MobileNo">
                                                    {{resourcesData.txtformno}}</label><%--onblur="return MobileNoValidation();"--%>
                                                <input id="FormNumber" class="form-control inputbox_bluebdr" maxlength="10" name="FormNumber" placeholder="Form Number" onkeypress="return isNumberKey(event); " type="text" value="" autocomplete="off" />
                                            </div>
                                        </div>
                                        ...
                                        <%--<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <label class="manadatory" for="txtformno">
                                                    {{resourcesData.txtformno}}</label>
                                                <input id="FormNumber" class="form-control" placeholder="Form Number" name="Form Number" onchange="return checkLength(this);" onkeypress="return ValidateAlpha(event);" type="text" autofocus="" maxlength="100" />
                                            </div>
                                        </div>--%>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <label class="manadatory" for="DDNumber">
                                                    {{resourcesData.txtddno}}</label><%--onblur="return MobileNoValidation();"--%>
                                                <input id="DDNumber" class="form-control inputbox_bluebdr" maxlength="6" name="DDNumber" placeholder="DD Number" onkeypress="return isNumberKey(event); " type="text" value="" autocomplete="off" />
                                            </div>
                                        </div>
                                        <%--     <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <label class="manadatory" for="txtddno">
                                                    {{resourcesData.txtddno}}</label>
                                                <input id="DDNumber" class="form-control" placeholder="DD Number" name="DD Number" onchange="return checkLength(this);" onkeypress="return ValidateAlpha(event);" type="text" autofocus="" maxlength="100" />
                                            </div>
                                        </div>--%>
                                    </div>
                                    ...
                                    <div class="box-body box-body-open">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input id="FatherName" class="form-control" placeholder="Father's Name" name="Father Name" type="text" value="" autofocus="" maxlength="100" onchange="return checkLength(this);" onkeypress="return ValidateAlpha(event);" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" data-val="true" data-val-number="Category" data-val-required="Please select your Category" id="category" name="Category" onchange="ShowPayment();">
                                ...
                                <div class="box-body box-body-open">
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="ctl00$ContentPlaceHolder1$Address1$AddressLine1" type="text" id="PAddressLine1" class="form-control" placeholder="First Line Address" maxlength="100" onchange="return checkLength(this);" autofocus="" />
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="ctl00$ContentPlaceHolder1$Address1$AddressLine2" type="text" id="PAddressLine2" class="form-control" placeholder="Second Line Address" maxlength="100" onchange="return checkLength(this);" autofocus="" />
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="ctl00$ContentPlaceHolder1$Address1$RoadStreetName" type="text" id="PRoadStreetName" class="form-control" placeholder="Road / Street Name" maxlength="100" onchange="return checkLength(this);" autofocus="" />
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="ctl00$ContentPlaceHolder1$Address1$LandMark" type="text" id="PLandMark" class="form-control" placeholder="Landmark" maxlength="100" onchange="return checkLength(this);" autofocus="" />
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input name="ctl00$ContentPlaceHolder1$Address1$Locality" type="text" id="PLocality" class="form-control" placeholder="Locality" maxlength="100" onchange="return checkLength(this);" autofocus="" />
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                        <div class="form-group">
                            ...
                            <div class="box-heading">
                                <h4 class="box-title">{{resourcesData.presentAddress}} <span style="font-size: 13px; padding-right: 0">{{resourcesData.forcorrespondence}}</span>
                                    <span class="col-md-5 pull-right" style="font-style: normal; font-size: 12px; text-align: right; padding-right: 0; padding-left: 0;">
                                        <input id="chkAddress" type="checkbox" style="vertical-align: bottom;" onclick="fnCopyAddress();" onchange="return checkLength(this);" />{{resourcesData.sameasPermanentAddress}}</span><span class="clearfix">
                                        </span>
                                </h4>
                            </div>
                            <div class="box-body box-body-open">
                                <div class="box-body box-body-open">
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="ctl00$ContentPlaceHolder1$Address2$AddressLine1" type="text" id="CAddressLine1" class="form-control" placeholder="First Line Address" maxlength="100" onchange="return checkLength(this);" autofocus="" />
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="ctl00$ContentPlaceHolder1$Address2$AddressLine2" type="text" id="CAddressLine2" class="form-control" placeholder="Second Line Address" maxlength="100" onchange="return checkLength(this);" autofocus="" />
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="ctl00$ContentPlaceHolder1$Address2$RoadStreetName" type="text" id="CRoadStreetName" class="form-control" placeholder="Road / Street Name" maxlength="100" onchange="return checkLength(this);" autofocus="" />
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="ctl00$ContentPlaceHolder1$Address2$LandMark" type="text" id="CLandMark" class="form-control" placeholder="Landmark" maxlength="100" onchange="return checkLength(this);" autofocus="" />
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input name="ctl00$ContentPlaceHolder1$Address2$Locality" type="text" id="CLocality" class="form-control" placeholder="Locality" maxlength="100" autofocus="" />
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                        <div class="form-group">
                            ...
                            <div class="box-body box-body-open">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="txtRegdte" class="form-control" name="txtRegdte" type="text" placeholder="DD/MM/YY" value="" autofocus="" title="Employment Exchange Registration Date" onkeypress="return ValidateAlpha(event);" onkeydown=" return allowBackspace(event);" maxlength="12" />
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                    <div class="form-group">
  ...
  <label for="checkbox"></label>
                                ...
                                <div class="clearfix"></div>
                                <div class="form-group mtop5" id="divPayment">
                                    <div class="col-lg-12 othrinfohd">
                                        <div class="col-md-9 pleft0">
                                            <p><span><span class="fom-Numbx">9.</span> {{resourcesData.section9}}</span></p>
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-12 othrinfosubhd2">
                                                <div class="col-md-9 pleft0">
                                                    <p class="pleft27">
                                                        <i class="fa fa-arrow-right pright5"></i>
                                                        <label class="manadatory" for="txtissuebanknameof200rs">
                                                            {{resourcesData.txtissuebanknameof200rs}}</label>
                                                    </p>
                                                </div>
                                                <div class="col-md-3 pleft0 pright0">
                                                    <div class="col-xs-12 pright0 pleft0">

                                                        <input id="txtissuebanknameof200rs" class="form-control" placeholder="DD Issue Bank Name"
                                                            name="Issued From Battalion" onchange="return checkLength(this);" onkeypress="return ValidateAlpha(event);"
                                                            type="text" autofocus="" maxlength="99" />
                                            ...
                                            <div class="col-lg-12 othrinfosubhd2">
                                                <div class="col-md-9 pleft0">
                                                    <p class="pleft27">
                                                        <i class="fa fa-arrow-right pright5"></i>
                                                        <label class="manadatory" for="txtsecddno">
                                                            {{resourcesData.secb}}</label>
                                                    </p>
                                                </div>
                                                <div class="col-md-3 pleft0 pright0">
                                                    <div class="col-xs-12 pright0 pleft0">
                                                        <input id="txtsecddno" class="form-control inputbox_bluebdr" maxlength="6" name="txtsecddno" placeholder="DD Number" onkeypress="return isNumberKey(event); " type="text" value="" autocomplete="off" />

                                                        <%--   <input id="txtsecddno" class="form-control" placeholder="DD Number"
                                                        name="DD Number" onchange="return checkLength(this);" onkeypress="return ValidateAlpha(event);"
                                                        type="text" autofocus="" maxlength="100" />--%>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 othrinfosubhd2">
                                                <div class="col-md-9 pleft0">
                                                    <p class="pleft27">
                                                        <i class="fa fa-arrow-right pright5"></i>
                                                        <label class="manadatory" for="IssueDateOd200Rs">
                                                            {{resourcesData.secc}}</label>
                                                    </p>
                                                </div>
                                                <div class="col-md-3 pleft0 pright0">
                                                    <div class="col-xs-12 pright0 pleft0">
                                                        <input id="IssueDateOd200Rs" class="form-control inputbox_bluebdr" name="IssueDate" placeholder="Issue Date" value="" autofocus="" onkeypress="return ValidateAlpha(event);" onkeydown=" return allowBackspace(event);" maxlength="12" />

                                                        <%--                                                  <input id="txtsecdateofissue" class="form-control" placeholder="Date Of Issue" 
                                                    name="Date Of Issue" onchange="return checkLength(this);" onkeypress="return ValidateAlpha(event);" 
                                                     type="text" autofocus="" maxlength="100" />--%>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 othrinfosubhd2">
                                                <div class="col-md-9 pleft0">
                                                    <p class="pleft27"><i class="fa fa-arrow-right pright5"></i>{{resourcesData.secd}}</p>
                                                </div>

                                                <%--   <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                            <div class="form-group">
                                            
                                                <input id="txtamount" class="form-control inputbox_bluebdr" maxlength="10" name="MobileNo" placeholder="Amount" onkeypress="return isNumberKey(event); " type="text" value="" autocomplete="off" />
                                            </div>
                                          </div>--%>
                                                ...
                                                <div class="col-md-3 pleft0 pright0">
                                                    <div class="col-xs-12 pright0 pleft0">
                                                        <input id="txtamount" class="form-control inputbox_bluebdr rupeeIcon" maxlength="3" readonly="true" name="Amount" placeholder="`" onkeypress="return isNumberKey(event); " type="text" value="200" autocomplete="off" />


                                                        <%-- <input id="txtamount" class="form-control" placeholder="Amount" 
                                                    name="Amount" onchange="return checkLength(this);" onkeypress="return ValidateAlpha(event);" 
                                                     type="text" autofocus="" maxlength="100" />--%>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <%-- <div class="col-md-3 pleft0 pright0">
                                            <div class="col-xs-6 pleft0">
                                                <input type="radio" name="radio9" id="rdoCrmYes1" value="yes" onclick="return fuShowHideDiv('divCirmeCase1', 1);" />
                                                <label for="CrmnlInvlv">{{resourcesData.yes}}</label>

                                            </div>
                                            <div class="col-xs-6">
                                                <input type="radio" name="radio9" id="rdoCrmNo1" value="no" onclick="return fuShowHideDiv('divCirmeCase1', 0);" />
    ...
    <asp:HiddenField ID="HFServiceID" runat="server" Value="395" />
