<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="NFBSAcknowledgement.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.NFBS.NFBSAcknowledgement" %>
        ...
        <div class="row" style="margin-top: 25px;">
            <div class="col-md-12 box-container mTop15">
                <div class="box-heading">
                    <h4 class="box-title register-num">SOCIAL SECURITY IMPOWERMENT OF PERSON WITH DISSABILITIES DEPARTMENT
                    </h4>
                </div>
                    ...
                    <asp:Panel ID="Panel1" runat="server" Style="margin: 0 auto; width: 800px; /*height: 1220px; overflow: auto; */">
                        ...
                        “ब”, अर्ज “थ”
                                ...
                                <div style="margin: 30px auto; width: 708px; font-size: 13px;">
                                    ...
                                    <div style="float: left; height: 30px; width: 150px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                        Mobile No.<span style="color: #F00">*</span>
                                    </div>
                                    <div style="float: left; height: 30px; width: 128px; border-bottom: 1px solid #999; margin: 0; padding: 5px 0 0 7px;">
                                    ...
                                    <div style="float: left; height: 30px; width: 128px; border-bottom: 1px solid #999; margin: 0; padding: 2px 0 0 7px;">
                                        <asp:Label ID="lblFather" runat="server"></asp:Label>
                                    </div>
                                    <div style="float: left; height: 30px; width: 120px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                        Deceased Name<span style="color: #F00">*</span>
                                    </div>
                                    <div style="float: left; height: 30px; width: 170px; border-bottom: 1px solid #999; margin: 0; padding: 2px 0 0 7px;">
                                        <asp:Label ID="lblDeceasedName" runat="server"></asp:Label>
                                    </div>
                                    <div style="float: left; height: 30px; width: 150px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                        Deceased Gender<span style="color: #F00">*</span>
                                    </div>
                                    <div style="float: left; height: 30px; width: 128px; border-bottom: 1px solid #999; margin: 0; padding: 2px 0 0 7px;">
                                    ...
                                    <div class="" style="float: left; height: 30px; width: 120px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                        BPL Card No.<span style="color: #F00">*</span>
                                    </div>
                                    <div style="float: left; height: 30px; width: 170px; border-bottom: 1px solid #999; margin: 0; padding: 2px 0 0 7px;">
                                        <asp:Label ID="lblBPLNo" runat="server"></asp:Label>
                                    </div>
                                    <div class="" style="float: left; height: 30px; width: 150px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                        BPL Card Year <span style="color: #F00">*</span>
                                    </div>
                                    <div style="float: left; height: 30px; width: 128px; border-bottom: 1px solid #999; margin: 0; padding: 2px 0 0 7px;">
                                        <asp:Label ID="lblBPLYear" runat="server" Text="22/08/2016"></asp:Label>
                                    </div>
                                    <div style="clear: both; margin: 0; line-height: 0; padding: 0;">
                                    </div>
                                    <div class=" " style="float: left; height: 30px; width: 150px; border: 1px solid #999; padding: 6px 0 0 7px; border-top: none; height: 145px;">
                                        Deceased Address <span style="color: #F00">*</span>
                                        <br />
                                    ...
                                    <div class=" " style="float: right; height: 25px; width: 558px; border: 1px solid #999; padding: 6px 0 0 7px; border-top: none; border-left: none; height: 145px;">
                                        <div style="height: 80px;">
                                            ...
                                            <asp:Label ID="lblapp_tehsil" runat="server" Font-Size="15px" Visible="false"></asp:Label>
                                            <asp:Label ID="lblapp_dist" runat="server" Font-Size="15px" Visible="false"></asp:Label>
                                            <asp:Label ID="lblpin_app" runat="server" Font-Size="15px" Visible="false"></asp:Label>
                                        </div>
                                    ...
                                    <div class=" " style="float: left; height: 28px; width: 190px; border: 1px solid #999; padding: 6px 0 0 7px; border-top: none;">
                                        Name of the Account Holder<span style="color: #F00">*</span>
                                    </div>
                                    <div class=" " style="float: right; height: 28px; width: 518px; border: 1px solid #999; padding: 6px 0 0 7px; border-top: none; border-left: none;">
                                        <asp:Label ID="lblAcHolder" runat="server" Font-Size="15px"></asp:Label>
                                    </div>
                                    <div style="clear: both; margin: 0; line-height: 0; padding: 0;">
                                    </div>
                                    <div style="float: left; height: 30px; width: 190px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                        Bank Account Number
                                    </div>
                                    <div style="float: left; height: 30px; width: 210px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none; border-left: none; border-right: none;">
                                        <asp:Label ID="lblAcNo" runat="server"></asp:Label>
                                    </div>
                                    <div style="float: left; height: 30px; width: 100px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                        IFSC Code <span style="color: #F00">*</span>
                                    </div>
                                    <div style="float: left; height: 30px; width: 208px; border-bottom: 1px solid #999; border-right: 1px solid #999; margin: 0; padding: 2px 0 0 7px;">
                                ...
                                <div style="margin: 5px auto; width: 708px;">
                                    <div style="border: 1px solid #999; background-color: #f3aba4; border-bottom: none; width: 708px; margin: 0 auto; padding: 6px 0 0 7px; font-weight: bold;">
                                        List of essential documents (enclosed with the application)
                        <div style="clear: both; margin: 0; line-height: 0; padding: 0;">
                        </div>
                                        <div>
                                        </div>
                                    ...
                                    <div class="" style="height: 300px; font-weight: normal;">
                                        <table cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 5px; border: 1px solid #999; text-align: justify; border-bottom: none; border-right: none;"
                                                    width="200px">Beneficiary BPL Card</td>
                                                <td style="padding: 5px; border: 1px solid #999; text-align: center; border-bottom: none;"
                                                    width="490px"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="padding: 5px; border: 1px solid #999; text-align: justify; border-bottom: none; border-right: none;"
                                                    width="200px">Beneficiary Voter ID</td>
                                                <td style="padding: 5px; border: 1px solid #999; text-align: center; border-bottom: none;"
                                                    width="490px"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="padding: 5px; border: 1px solid #999; text-align: justify; border-right: none;"
                                                    width="200px">Death Certificate</td>
                                                <td style="padding: 5px; border: 1px solid #999; text-align: center;" width="490px"></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
