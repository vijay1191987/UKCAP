<%@ Page Title="" Language="C#" MasterPageFile="~/WebAppUK/master/UKAdmin.Master" AutoEventWireup="true" CodeBehind="TradersLicense.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.TradersLicenses.TradersLicense" %>

<%@ Register Src="~/WebApp/Control/FormTitle.ascx" TagPrefix="uc1" TagName="FormTitle" %>
<%@ Register Src="~/WebApp/Control/Address.ascx" TagPrefix="uc1" TagName="Address" %>
<%@ Register Src="~/WebApp/Control/ApplicationSteps.ascx" TagPrefix="uc1" TagName="ApplicatitonSeps" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="/WebApp/Kiosk/TradersLicenses/TradersLicense.js?v=<%=CitizenPortal.Common.GlobalValues.JSVersion%>"></script>
        ...
        <div ng-controller="ctrl">
            <div id="page-wrapper" style="min-height: 500px !important;">
                ...
                <div class="row clearfix">
                    <uc1:ApplicatitonSeps runat="server" ID="ApplicationSteps" />
                </div>
                ...
                <div class="row" id="divDecease" runat="server">
                    ...
                    <div class="col-md-12 box-container mTop15">
                        <div class="box-heading">
                            <h4 class="box-title register-num">For Old Trade License holders
                            </h4>
                        </div>
                        <div class="box-body box-body-open">
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label class="manadatory" for="OldTradeLicenseNo">
                                       Trade Licence No </label>
                                    <input id="OldTradeLicenseNo" class="form-control" placeholder="Trade License No" name="OldTradeLicenseNo" type="text" value="" maxlength="25"
                                          onchange="return checkLength(this);" autofocus />
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label class="manadatory" for="OldFinancialYear">
                                        Financial Year</label>
                                    <input id="OldFinancialYear" class="form-control" placeholder="Financial Year" name="OldFinancialYear" type="text" value="" maxlength="10"
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                        ...
                                        <div class="form-group">
                                    <label for="DateofRegisteration" class="manadatory">
                                        Date Of Registeration</label>
                                    <input id="DateofRegisteration" class="form-control" placeholder="DD/MM/YYYY" name="DateofRegisteration" type="text" value=""    maxlength="12" 
