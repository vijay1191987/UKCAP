<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Preview.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.Birth.Preview" %>
                    ...
                    <div style="margin: 0 auto; height: 1191px; width: 794px; border: 3px solid #000; padding: 1px;">
                        <div style="margin: 0 auto; height: 1182px; width: 785px; border: 1px solid #000; background-image: url('../images/bgLogo.png'); background-image: url('../images/bgLogo.png'); background-size: 590px; background-repeat: no-repeat; background-position: center center;">
                            ...
                            <div style="margin: 30px auto; width: 708px; font-size: 13px;">
                                ...
                                <div style="float: left; height: 30px; width: 115px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                    Aadhar No.
                                </div>
                                ...
                                <div style="float: left; height: 30px; width: 129px; border-bottom: 1px solid #999; margin: 0; padding: 5px 0 0 7px;">
                                    <asp:Label ID="lblMobile" runat="server"></asp:Label>
                                </div>
                                <div style="float: right; height: 167px; width: 140px; border: 1px solid #999; border-top: none; padding: 0;">
                                    <asp:Image ID="Image3" runat="server" Height="167px" Width="140px" ImageAlign="Right" ImageUrl="~/WebApp/Kiosk/Images/photo.png" />
                                </div>
                                <div style="float: left; height: 27px; width: 115px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                ...
                                <div style="float: left; height: 27px; width: 120px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                    Relation with Child<span style="color: #F00">*</span>
                                </div>
                                <div style="float: left; height: 30px; width: 129px; border-bottom: 1px solid #999; margin: 0; padding: 2px 0 0 7px;">
                                ...
                                <div style="float: left; height: 27px; width: 129px; border-bottom: 1px solid #999; margin: 0; padding: 5px 0 0 7px;">
                                ...
                                <div class="" style="float: left; height: 27px; width: 115px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                    Date of Birth <span style="color: #F00">*</span>
                                </div>
                                <div style="float: left; height: 30px; width: 170px; border-bottom: 1px solid #999; margin: 0; padding: 2px 0 0 7px;">
                                    <asp:Label ID="lblDOB" runat="server" Text="22/08/2016"></asp:Label>
                                </div>
                                <div class="" style="float: left; height: 27px; width: 120px; border: 1px solid #999; padding: 5px 0 0 7px; border-top: none;">
                                ...
                                <div class=" " style="float: right; height: 25px; width: 541px; border: 1px solid #999; padding: 6px 0 0 7px; border-top: none; border-left: none; height: 145px;">
                                    ...
                                    <div style="height: 30px; border: 1px solid #999; border-left: none; border-right: 0; margin-left: -7px;">
                                        <div style="float: left; width: 60px; border-right: 1px solid #999; height: 26px; background-color: #f3aba4; padding: 5px 0 0 7px;">
                                            Village
                                        </div>
                                        <div style="float: left; width: 190px; border-right: 1px solid #999; height: 26px; padding-left: 7px;">
                                            <asp:Label ID="lblvillage" runat="server" Font-Size="15px"></asp:Label>
                                        </div>
                                        <div style="float: left; width: 60px; height: 26px; padding: 5px 0 0 7px; border-right: 1px solid #999; background-color: #f3aba4;">
                                            Taluka
                                        </div>
                                        <div style="float: left; width: 190px; height: 26px; padding: 5px 0 0 7px;">
                            ...
                            <div class="" style="height: 300px; font-weight: normal; width: 708px; margin: 0 auto;">
                                ...
                                <table cellpadding="5" cellspacing="0" class="table-bordered" style="width: 100%; border: 0;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left;" colspan="3">
                                            <asp:Label ID="lblBeneficiary" runat="server" CssClass="lbl_value" Style="white-space: normal !important;"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left;">
