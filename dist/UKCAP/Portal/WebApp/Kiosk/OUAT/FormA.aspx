<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="FormA.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.OUAT.FORMA" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="/WebApp/Kiosk/OUAT/OUATFormA.js?v=<%=CitizenPortal.Common.GlobalValues.JSVersion%>"></script>
    ...
    <%-- <script type="text/javascript">
        ...
        function PermanentPinCode() {
            debugger;
            var PinCode = $('#ctl00$ContentPlaceHolder1$Address1$PinCode').val();
            var state = $('#ctl00$ContentPlaceHolder1$Address1$ddlState').val();
            if (state == 21) {
                var pinmatch = /^[7]\d{5}$/;
                if (!pinmatch.test(PinCode)) {
                    alertPopup("Form Validation", "Please enter valid PinCode, starting with 7 ");
                    $('#ctl00$ContentPlaceHolder1$Address1$PinCode').val("");
                    opt = 1;
     ...
     <script type="text/javascript">
        ...
        function PresentPinCode() {
            debugger;
            var PinCode = $('#ctl00$ContentPlaceHolder1$Address2$PinCode').val();
            var state = $('#ctl00$ContentPlaceHolder1$Address2$ddlState').val();
            if (state == 21) {
                var pinmatch = /^[7]\d{5}$/;
                if (!pinmatch.test(PinCode)) {
                    alertPopup("Form Validation", "Please enter valid PinCode, starting with 7");
                    $('#ctl00$ContentPlaceHolder1$Address2$PinCode').val("");
                    opt = 1;
        ...
        $(document).ready(function () {
            ...
            $("#ctl00$ContentPlaceHolder1$Address2$PinCode").bind("change", function (e) { return PresentPinCode(); });
        });
     </script>--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ClientIDMode="Static">
    ...
    <div id="progressbar" class="modalBackground" runat="server" clientidmode="Static" style="height: 400%; border: 1px solid #ccc; display: none;">
        <div style="z-index: 105; left: 40%; position: absolute; bottom: 10%;" class="text-center">
                    ...
                    <div>
                        ...
                        <div class="row">
                            ...
                            <div id="" class="col-md-3 p0">
                                <%--<div id="divHelp" class="col-md-12 box-container">
                                    <div class="box-heading">
                                    ...
                                    <div class="box-body box-body-open">
                                        <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
                                            ...
                                            <label class="btn-link text-left"><i class="fa fa-hand-o-up"></i><a href="../../../g2c/PDF/OUAT _UG_PROSPECTUS_2017-18.pdf" target="_blank"> Read Prospectus</a></label>
                                            <label class="btn-link text-left"><i class="fa fa-hand-o-up"></i><a href="../../../g2c/img/OUAT_UG_Admission_Notice_2017-18.jpg" target="_blank"> Admission Notice</a></label>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                    </div>
                                       ...
                                       <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input name="ctl00$ContentPlaceHolder1$Address1$PinCode" type="text" id="PPinCode" class="form-control" placeholder="PIN" maxlength="6" onchange="return PermanentPinCode();" onkeypress="return isNumberKey(event);" autofocus="" />
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                    ...
                                    <div class="box-body box-body-open">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input id="CtxtDistrict" class="form-control" placeholder="Current District" name="Current District" value="" maxlength="30" autofocus="" style="" />
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input id="CtxtTaluka" class="form-control" placeholder="Current Block" name="Current Block" value="" maxlength="30" autofocus="" style="" />
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input id="CtxtVillage" class="form-control" placeholder="Current Panchayat" name="Current Panchayat" value="" maxlength="30" autofocus="" style="" />
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input name="ctl00$ContentPlaceHolder1$Address2$PinCode" type="text" id="CPinCode" class="form-control"  onchange="return PresentPinCode();" placeholder="PIN" maxlength="6" onkeypress="return isNumberKey(event);" autofocus="" />
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                        ...
                        <div class="row" id="divNRIDetails">
                            <div id="" class="col-md-12 box-container">
                                <div class="box-heading" id="">
                                    <h4 class="box-title">Choice of Centre
                                    </h4>
                                </div>
                                ...
                                <div class="box-body box-body-open">
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            <label class="manadatory" for="ddlCenter">
                                                First {{resourcesData.examcenter}}</label>
                                            <select name="ddlCenter1" id="ddlCenter1" class="form-control" data-val="true" data-val-number="ExamCenter" data-val-required="Please select Exam Center.">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                        <div class="form-group">
                                            <label class="manadatory" for="ddlCenter2">
                                                Second {{resourcesData.examcenter}}</label>
                                            <select name="ddlCenter2" id="ddlCenter2" class="form-control" data-val="true" data-val-number="ExamCenter" data-val-required="Please select Exam Center.">
                                                <option value="0">Select Exam Center</option>
                                            </select>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
                                        <div class="form-group">
                                            <label class="manadatory" for="ddlCenter3">
                                                Third {{resourcesData.examcenter}}</label>
                                            <select name="ddlCenter3" id="ddlCenter3" class="form-control" data-val="true" data-val-number="ExamCenter" data-val-required="Please select Exam Center.">
                                                <option value="0">Select Exam Center</option>
                                            </select>
                    ...
                    <div id="divBtn" class="row">
                        <div class="col-md-12 box-container" style="margin-top: 5px;">
                            <div class="box-body box-body-open" style="text-align: center;">
                                <input type="button" id="btnSubmit" class="btn btn-success" value="Register & Proceed" title="Proceed to Upload Necessary Document" />
