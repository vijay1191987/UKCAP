                ...
                <div class="row" id="divCitizenProfile">
                                    ...
                                    <div class="box-body box-body-open">
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="Enter 12 digit Aadhaar Number" name="txtAadhaar" type="text" value="KH1289600442" id="txtAppID" maxlength="12" onkeypress="return isNumberKey(event);"
                                                    autofocus />
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="" name="txtRollNo" type="text" value="AK041004" id="txtRollNo" readonly
                                                    autofocus />
                                            </div>
                                        </div>
                                    ...
                                    <div class="box-body box-body-open">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="Enter 12 digit Aadhaar Number" name="txtAadhaar" type="text" value="43522011788" id="UID" maxlength="12" onkeypress="return isNumberKey(event);"
                                                    autofocus />
                                            </div>
                                        </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12 othrinfosubhd2">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="">
                                                <p class=""><i class="fa fa-info-circle pright5" style="color: #000;"></i>Green Card Holder candidate needs to upload <b>Scanned copy of GREEN CARD depicting the name of the candidate and his/her parents</b> in attachment page. Please refer <b>Clause 3.2</b> <span style="color: red;">*</span></p>
                                ...
                                <div id="divPH">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-12 othrinfosubhd2">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="">
                                                <p class=""><i class="fa fa-info-circle pright5" style="color: #000;"></i>Handicapped Candidate need to upload <b>Physical Handicapped certificate from Competent Medical Authority</b> in attachment page. Please refer <b>Clause 3.2</b> <span style="color: red;">*</span></p>
                                ...
                                <div class="form-group" id="divNRI">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12 othrinfosubhd2">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="">
                                            <p class=""><i class="fa fa-info-circle pright5" style="color: #000;"></i>NRI Candidate need to fill the <b>ANNEXURE-III,</b> and upload it (in attachment page) with supporting documents (<b>Valid Passport,  Valid Visa and Residential Proof</b>). Please refer <b>Clause 3.6</b> <span style="color: red;">*</span></p>
                                        </div>
                                ...
                                <div id="divWO">
                                            ...
                                            <div class="col-md-3 pleft0 pright0">
                                                <div class="col-xs-12 pleft0">
                                                    <select name="ddlWesternDistrict" id="ddlWesternDistrict" class="form-control" data-val="true" data-val-number="ddlWesternDistrict" data-val-required="Please select Residence Type">
                                                        ...
                                                        <option value="200">ANGUL</option>
                                                        <option value="201">KHURDA</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12 othrinfosubhd2">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="">
                                                <p class=""><i class="fa fa-info-circle pright5" style="color: #000;"></i>Western Odisha candidate need to upload <b>Permanent Residential Certificate </b>in attachment page. Please refer <b>Clause 3.4</b> <span style="color: red;">*</span></p>
                                ...
                                <div class="form-group" id="divEmplyeeCase">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div style="display: none">
                                         ...
                                         <div class="col-lg-12 othrinfosubhd2">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="">
                                                <p class=""><i class="fa fa-info-circle pright5" style="color: #000;"></i>OUAT Employee reservation category applicant need to upload the <b>scanned copy of filled Annexure-IV</b>. Please refer <b>Clause 3.6</b> <span style="color: red;">*</span></p>
                    ...
                    <%--End Reservation Detail--%>
                                        ...
                                        <table style="width: 100%; margin: 0;" class="table-striped table-bordered table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input id="txtBoardName" class="form-control" placeholder="Name of the Board / Council, State" name="txtBoardName" type="text" value="" autofocus="" maxlength="30" onkeypress="return ValidateAlpha(event);" /></td>
                                                    <td>
                                        ...
                                        <table style="width: 100%; margin: 0;" class="table-striped table-bordered table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input id="txtBoardName2" class="form-control" placeholder="Name of the Board / Council, State" name="txtBoardName2" type="text" value="" autofocus="" maxlength="30" onkeypress="return ValidateAlpha(event);" /></td>
                                                    <td>
                                                        <input id="txtExmntnName2" class="form-control" placeholder="Examination Name" name="txtExmntnName2" type="text" value="" autofocus="" maxlength="30" onkeypress="return ValidateAlpha(event);" />
                        ...
                        <div class="row" id="div1" runat="server">
                            <div class="col-md-12 box-container">
                                <div class="box-heading">
                                    <h4 class="box-title register-num">Select Marks Partarn and enter the marks scrored in 10+2 Science Examination
                                    </h4>
                                </div>
                                <div class="box-body box-body-open" style="padding: 0px;">
                                    <table style="width: 100%; margin: 0;" class="table-striped table-bordered table">
                                        <tr>
                                            <td>
                                                <input type="radio" name="marks" id="rbtnMarkN" value="yes2" onchange="return checked();" onclick="return fuMarksPartern('1');" />CHSE & CBSE Marks Partern (Separate marks for Theory & Practical)
                                             </td>
                                            <td>                                                
                                                <input type="radio" name="marks" id="rbtnMarkY" value="yes1" onchange="return checked();" onclick="return fuMarksPartern('0');" />ICSE & Other Board Marks Partern (Combined marks including Theory & Practical)
                                            ...
                                            <table style="width: 100%; margin-bottom: 0;" class="table table-striped table-bordered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="">
                                                            <input id="txtTMT_Physics" class="form-control" placeholder="0" name="txtTotalPhysics0" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus /></td>
                                                        <td style="">
                                                            <input id="txtMOT_Physics" class="form-control" placeholder="0" name="txtTotalPhysics1" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus /></td>
                                                        <td style="" id="tdPTMP">
                                                            <input id="txtTMP_Physics" class="form-control" placeholder="0" name="txtTotalPhysics" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus />
                                                        </td>
                                                        <td style="" id="thPMOP">
                                                            <input id="txtMOP_Physics" class="form-control" placeholder="0" name="txtMarksObtainPhysics" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus maxlength="99" />
                                                        </td>
                                                        <td style="">
                                                            <input id="txtTMTP_Physics" class="form-control" placeholder="0" name="txtTotalPhysics15" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus readonly="true" /></td>
                                                        <td style="">
                                                            <input id="txtTMOTP_Physics" class="form-control" placeholder="0" name="txtTotalPhysics10" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus readonly="true" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="">2.</td>
                                                        ...
                                                        <td>
                                                            <input id="txtTMT_Chemistry" class="form-control" placeholder="0" name="txtTotalPhysics2" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus /></td>
                                                        <td>
                                                            <input id="txtMOT_Chemistry" class="form-control" placeholder="0" name="txtTotalPhysics3" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus /></td>
                                                        <td id="tdPTMC">
                                                            <input id="txtTMP_Chemistry" class="form-control" placeholder="0" name="txtTotalChemistry" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus />
                                                        </td>
                                                        <td style="text-align: right" id="thPMOC">
                                                            <input id="txtMOP_Chemistry" class="form-control" placeholder="0" name="txtMarksObtainChemistry" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus maxlength="99" />
                                                        </td>
                                                        <td style="text-align: right">
                                                            <input id="txtTMTP_Chemistry" class="form-control" placeholder="0" name="txtTotalPhysics16" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus readonly="true" /></td>
                                                        <td style="text-align: right">
                                                            <input id="txtTMOTP_Chemistry" class="form-control" placeholder="0" name="txtTotalPhysics11" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus readonly="true" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="">3.</td>
                                                        ...
                                                        <td style="">
                                                            <input id="txtTMT_Maths" class="form-control" placeholder="0" name="txtTotalPhysics4" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus /></td>
                                                        <td style="">
                                                            <input id="txtMOT_Maths" class="form-control" placeholder="0" name="txtTotalPhysics5" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus /></td>
                                                        <td style="" id="tdPTMPM">
                                                            <input id="txtTMP_Maths" class="form-control" placeholder="0" name="txtTotalMath" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus />
                                                        </td>
                                                        <td style="" id="thPMOM">
                                                            <input id="txtMOP_Maths" class="form-control" placeholder="0" name="txtMarksObtainMath" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus maxlength="99" />
                                                        </td>
                                                        <td style="">
                                                            <input id="txtTMTP_Maths" class="form-control" placeholder="0" name="txtTotalPhysics17" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus readonly="true" /></td>
                                                        <td style="">
                                                            <input id="txtTMOTP_Maths" class="form-control" placeholder="0" name="txtTotalPhysics12" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus readonly="true" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="">4.</td>
                                                        ...
                                                        <td style="">
                                                            <input id="txtTMT_Botany" class="form-control" placeholder="0" name="txtTotalPhysics6" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus /></td>
                                                        <td style="">
                                                            <input id="txtMOT_Botany" class="form-control" placeholder="0" name="txtTotalPhysics7" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus /></td>
                                                        <td style="" id="tdPTMB">
                                                            <input id="txtTMP_Botany" class="form-control" placeholder="0" name="txtTotalBio" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus />
                                                        </td>
                                                        <td style="" id="thPMOB">
                                                            <input id="txtMOP_Botany" class="form-control" placeholder="0" name="txtMarksObtainBio" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus maxlength="99" />
                                                        </td>
                                                        <td style="">
                                                            <input id="txtTMTP_Botany" class="form-control" placeholder="0" name="txtTotalPhysics18" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus readonly="true" /></td>

                                                        <td style="">
                                                            <input id="txtTMOTP_Botany" class="form-control" placeholder="0" name="txtTotalPhysics13" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus readonly="true" /></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="">
                                                            <input id="txtTMT_Zoology" class="form-control" placeholder="0" name="txtTotalPhysics8" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus /></td>
                                                        <td style="">
                                                            <input id="txtMOT_Zoology" class="form-control" placeholder="0" name="txtTotalPhysics9" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus /></td>
                                                        <td style="" id="tdPTMPZ">
                                                            <input id="txtTMP_Zoology" class="form-control" placeholder="0" name="txtTotalZoo" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus />
                                                        </td>
                                                        <td style="" id="thPMOZ">
                                                            <input id="txtMOP_Zoology" class="form-control" placeholder="0" name="txtMarksObtainZoo" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus maxlength="99" />
                                                        </td>
                                                        <td style="">
                                                            <input id="txtTMTP_Zoology" class="form-control" placeholder="0" name="txtTotalPhysics19" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus readonly="true" /></td>

                                                        <td style="">
                                                            <input id="txtTMOTP_Zoology" class="form-control" placeholder="0" name="txtTotalPhysics14" type="text" value="" style="text-align: right" onchange="TotalMarksInTheory();"
                                                                autofocus readonly="true" /></td>
