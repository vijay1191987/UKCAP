...
function GetEducationBoard(StateCode, EdBoard) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: '/WebApp/Kiosk/OUAT/OUAT.aspx/GetEducationBoard',
        data: '{"prefix":"' + category + '","StateCode":"' + SelIndex + '"}',
        processData: false,
        dataType: "json",
        success: function (response) {
...
function GetEmploymentExchange(StateCode, EdBoard) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: '/WebApp/Kiosk/OUAT/OUAT.aspx/GetEmploymentExchange',
...
function GetRTOList(DistrictCode, RTO) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: '/WebApp/Kiosk/OUAT/OUAT.aspx/GetRTOList',
...
function GetPoliceStation(StateCode, DistrictCode, PoliceStation) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: '/WebApp/Kiosk/OUAT/OUAT.aspx/GetPoliceStation',
