<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgroFormAcknowledgement.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.OUAT.AgroFormAcknowledgement" %>
                ...
                <div style="margin: 0 auto; height: auto; width: 100%; border: 3px solid #000; padding: 1px; font-family: Arial">
                    <div style="margin: 0 auto; height: auto; width: 100%; border: 1px solid #000; background-image: url('../images/ouatlogobg.png'); background-image: url('../images/ouatlogobg.png'); background-size: 590px; background-repeat: no-repeat; background-position: center center;">
                        ...
                        <div style="text-align: center; font-size: 20px; font-weight: bolder; padding: 5px; text-transform: uppercase; background-color: #808080; color: #fff;">
                            <asp:Label runat="server" ID="lblCertificateName" Style="font-size: 20px; text-transform: uppercase;">Acknowledgement For Admission into OUAT-UG of AgroPolytechnic</asp:Label>
                            <br />
                            <span style="font-size: 20px">Student Course 2017-18 
                            </span>
                        ...
                        <div style="margin: 10px; width: 100%; height: auto; font-size: 13px;">
                            ...
                            <table width="600" cellpadding="5" cellspacing="0" class="table-bordered" style="width: 98%; border: 1px solid #999;">
                                <tr>
                                    <td colspan="6" class="hdbg" style="padding: 5px; text-align: left; font-size: 14px; border-right: 1px solid #999; border-left: 1px solid #999;"><b>Academic Information for Agro-Polytechnic</b></td>
                                </tr>
                                <tr>
                                    <td width="16%" style="padding:5px; color: #383E4B; font-weight:bold; border: 1px solid #999;">Admission Number</td>
                                    <td width="16%" style="padding:5px; border: 1px solid #999;">
                                        <asp:Label ID="lblAgroNumber" runat="server"></asp:Label>
                                    </td>
                                    <td width="16%" style="padding:5px; color: #383E4B; font-weight:bold; border: 1px solid #999;">Agro-Polytechnic Centre</td>
                                    <td width="16%" style="padding:5px; border: 1px solid #999;">
                                        <asp:Label ID="lblAgroCentre" runat="server"></asp:Label>
                                    </td>
                                    <td width="16%" style="padding:5px; color: #383E4B; font-weight:bold; border: 1px solid #999;">Agro-Polytechnic Stream</td>
                                    <td width="16%" style="padding:5px; border: 1px solid #999;">
                                        <asp:Label ID="lblAgroStream" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
