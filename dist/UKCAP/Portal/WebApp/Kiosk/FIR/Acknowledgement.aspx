<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acknowledgement.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.FIR.Acknowledgement" %>
                        ...
                        <div style="margin: 0 auto; height: 1191px; width: 794px; border: 3px solid #000; padding: 1px; font-family: Arial">
                            <div style="margin: 0 auto; height: 1182px; width: 785px; border: 1px solid #000; background-image: url('../images/bgLogo.png'); background-image: url('../images/bgLogo.png'); background-size: 590px; background-repeat: no-repeat; background-position: center center;">
                                ...
                                <div style="text-align: center; font-size: 20px; font-weight: bolder; padding: 5px; text-transform: uppercase; background-color: #808080; color: #fff;">
                                    <asp:Label runat="server" ID="lblCertificateName" Style="font-size: 20px; font-weight: bolder; text-transform: uppercase;" Text="FIR Registration"></asp:Label>
                                </div>
                                <%----------End title section ---------%>
                                ...
                                <div style="margin: 10px auto; width: 708px; font-size: 13px;">
                                    ...
                                    <table cellpadding="5" cellspacing="0" class="table-bordered" style="width: 100%; border: 0;">
                                        ...
                                        <tr>
                                            <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 135px;">
                                                <asp:Label ID="Label36" runat="server" Text="Date of Incident"></asp:Label>
                                            </td>
                                            <td style="padding: 5px; border: 1px solid #999; text-align: left;">
                                                <asp:Label ID="lblDate" runat="server"></asp:Label>
                                            </td>
                                            <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 120px;">
                                                <asp:Label ID="Label2" runat="server" Text="Place of Incident"></asp:Label>
                                            </td>
                                            <td style="padding: 5px; border: 1px solid #999; text-align: left;">
                                        ...
                                        <tr>
                                            <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 135px;">
                                                <asp:Label ID="lblCategory2" runat="server">Complaint Category</asp:Label>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 135px;">
                                                <asp:Label ID="lblCategory5" runat="server">Description</asp:Label>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 135px;">
                                                <asp:Label ID="Label38" runat="server" Text="Particulars"></asp:Label>
                                            </td>
                                    ...
                                    <table cellpadding="5" cellspacing="0" class="table-bordered" style="width: 100%; border: 0;">
                                        <tr>
                                            <td style="padding: 5px; border: 1px solid #999; text-align: left;" colspan="5"><b>Accused / Suspects Details</b></td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 1%; border: 1px solid #999; text-align: left; width: 5%; white-space: nowrap;">
                                                Sl. No.</td>
                                            <td style="padding: 1%; border: 1px solid #999; text-align: left; width: 15%; white-space: nowrap;">
                                                Name</td>      
                                            <td style="padding: 1%; border: 1px solid #999; text-align: left; width: 25%; white-space: nowrap;">
                                                Address</td>    
                                            <td style="padding: 1%; border: 1px solid #999; text-align: left; width: 10%; white-space: nowrap;">
                                                Contact</td>    
                                            <td style="padding: 1%; border: 1px solid #999; text-align: left; width: 25%; white-space: nowrap;">
                                                Remarks</td>
                                        </tr>
