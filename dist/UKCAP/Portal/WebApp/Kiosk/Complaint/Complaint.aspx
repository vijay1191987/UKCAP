<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="Complaint.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.Complaint.Complaint" %>
    ...
    <div id="intrnlContent" ng-app="appmodule">
        <div ng-controller="ctrl">
            <div id="page-wrapper" style="min-height: 500px !important;">
                            ...
                            <div class="box-body box-body-open">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="RefID" class="form-control" name="RefID" type="text" value="" maxlength="25"
                                            autofocus />
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input id="txtofficer" class="form-control" name="txtofficer" type="text" value=""
                                            autofocus />
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                ...
                <asp:HiddenField ID="HFServiceID" Value="386" runat="server" />
            </div>
        </div>
    </div>
</asp:Content>
