...
function PrintContent(sHeadingHTML,sWinHTML,CSSPath)
{
	 ...
	 var CSSContent='';
                ...
                {
                   CSSContent=CSSContent+'<link href="'+CSSPath[tempI]+'" rel="Stylesheet" media="print" />';
                }
...
//}
	...
	function PrintContentTH(sHeadingHTML, EId, CSSPath) {
	    ...
	    for (var tempI = 0; tempI < CSSPath.length; tempI++) {
	        CSSContent = CSSContent + '<link media="print" href="' + CSSPath[tempI] + '" rel="Stylesheet" />';
	    }

	    CSSContent = CSSContent + '<style type="text/css" rel="stylesheet">';
	    CSSContent = CSSContent + 'html,body {margin: 0px 0px 0px 0px;padding: 0px 0px 0px 0px;}';
	    CSSContent = CSSContent + '.pagebreak{page-break-after:always;margin:0px 0px 0px 0px;padding:0px 0px 0px 0px;}';
	    CSSContent = CSSContent + '</style>';
	    ...
	    Content = Content + '<head>' + CSSContent + '</head>';
	    //Content =Content+'<body>'+'<table align=center>'+'<tr><td>' + sHeadingHTML + '</td></tr>';
	    Content = Content + '<body>' + sHeadingHTML;
	    //Content =Content+'<tr><td>' + sWinHTML + '</td></tr>';
	    //Content =Content+'</table>';
	    Content = Content + sWinHTML;


	    Content = Content + '<P style="height:120px;">&nbsp;</p><P CLASS="pagebreakhere">&nbsp;</p>';
	    Content = Content + sWinHTML;
	    Content = Content + '<P style="height:120px;">&nbsp;</p><P CLASS="pagebreakhere">&nbsp;</p>';
	    Content = Content + sWinHTML;
