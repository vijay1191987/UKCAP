<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Master/G2G.Master" AutoEventWireup="true" CodeBehind="Tasklist.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.Tasklist" %>
                        ...
                        <div class="box-body box-body-open">
                            <div class="col-lg-3">
                                <div class="tasklistbox">
                                    <div class="taskhd pentaskhd">Pending for Acceptance</div>
                                    <div class="listview">
                                        <input name="" type="text" placeholder="Search Service" class="form-control listfind" onfocus="" />
                                        <%--<ul>
                                            <li>Birth Certificate	<span>13</span></li>
                                            <li>Death Certificate	<span>13</span></li>
                                            <li>Marriage Certificate	<span>13</span></li>
                                            <li>Caste Certificate	<span>13</span></li>
                                            <li>Certificate	<span>13</span></li>
                                            <li>Birth Certificate	<span>13</span></li>
                                            <li>Birth Certificate	<span>13</span></li>
                                            <li>Birth Certificate	<span>13</span></li>
                                            <li>Birth Certificate	<span>13</span></li>
                                        </ul>--%>
                            <asp:Panel ID="pnlPendingForAcceptance" runat="server" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="tasklistbox">
                                    <div class="taskhd apprhd">Pending for Action</div>
                                    <div class="listview">
                                        <input name="" type="text" placeholder="Search Service" class="form-control listfind" onfocus="" />
                                        <%--<ul>
                                            <li>Birth Certificate	<span>13</span></li>
                            ...
                            <asp:Panel ID="pnlPendingForApproval" runat="server" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="tasklistbox">
                                    <div class="taskhd penapphd">Application Received Back</div>
                                    <div class="listview">
                                        <input name="" type="text" placeholder="Search Service" class="form-control listfind" onfocus="" />
                                        <%--<ul>
                                            <li>Birth Certificate	<span>13</span></li>
                            ...
                            <asp:Panel ID="pnlPendingForAction" runat="server" />
                            ...
                            <div class="col-lg-3">
                                <div class="tasklistbox">
                                    <div class="taskhd rejhd">Pending for Approval</div>
                                    <div class="listview">
                                        <input name="" type="text" placeholder="Search Service" class="form-control listfind" onfocus="" />
                                        <%--<ul>
                                            <li>Birth Certificate	<span>13</span></li>
                            ...
                            <asp:Panel ID="pnlPendingForAssignment" runat="server" />
                                    </div>
                                </div>
                            </div>
                            <div class="clearfix">
                        ...
                        <div class="row">
                            <div class="col-md-12 box-container" id="divBtn">
                                <div class="box-body box-body-open" style="text-align: center;">
                                    ...
                                    <%--<asp:Button ID="btnReject" runat="server" CommandName="Cancel" OnClientClick="return ConfirmMessage(0);"
                                        CssClass="btn btn-danger" PostBackUrl="" Text="Reject" OnClick="btnReject_Click" />--%>
                                </div>
                            </div>
                            <div class="clearfix">
                            </div>
