<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmWrittenExam_BroadSheetDataEntryReport.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.OISF.PM.FrmWrittenExam_BroadSheetDataEntryReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Report  Broad Sheet </title>
            ...
            <div class="row">
                <div class="col-md-12 box-container mTop15">
                    <div class="box-heading">
                        <h4 class="box-title" style="text-align:center">Broad Sheet Report</h4>
                    </div>
                             ...
                             <td><asp:DropDownList ID="drpCenter" runat="server" Height="40px"  Width="406px"></asp:DropDownList></td>
                                ...
                                <tr>
                                   <td colspan="4"  align="center">
                                        ...
                                        <asp:Button ID="btnPrint" runat="server" Text="Print" Width="99px" Height="35px" OnClick="btnPrint_Click"   />
                                ...
                                <tr>
                                    <td colspan="4">
                                        ...
                                        <asp:GridView ID="grdBroadSheet" runat="server" Width="100%" AutoGenerateColumns="False"   >
                                            <Columns>
                                                   ...
                                                   <asp:TemplateField HeaderText="Final<br/>Status">
                                                ...
                                                <asp:TemplateField HeaderText="Written <br/>Exam">
                                               <EditItemTemplate>
                                                        <asp:TextBox ID="txtWrittenExam" runat="server"  Text='<%# Eval("WrittenExam").ToString() %>' Width="15Px" ></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Education<br/> Ach.">
                                             <EditItemTemplate>
                                                       
                                                        <asp:DropDownList ID="drpEducationalAchievementGrd" runat="server" Width="25Px"  >
                                                ...
                                                <asp:TemplateField HeaderText="Sport<br/> Ach.">
                                                    <EditItemTemplate>
                                                          ...
                                                          <asp:DropDownList ID="drpSportAchievementGrd" runat="server" Width="25Px" >
                                                            ...
                                                            <asp:ListItem Value="I5">Participated in International Sports </asp:ListItem>
                                                ...
                                                <asp:TemplateField HeaderText="NCC">
                                                    <EditItemTemplate>
                                                         ...
                                                         <asp:DropDownList ID="drpNCCCertificateGrd" runat="server" Width="25Px" >
                                               ...
                                               <%--   <asp:TemplateField HeaderText="Cat." >
                                                        ...
                                                        <EditItemTemplate>
                                                         ...
                                                         <asp:DropDownList ID="drpCategoryGrd" runat="server" Width="25Px">
                                                  ...
                                                  <asp:TemplateField HeaderText="Height<br/>(c.m.)">
                                                   ...
                                                   <asp:TemplateField HeaderText="Bonus <br/>Marks<br/>Height">
                                                      <EditItemTemplate>
                                                         ...
                                                         <asp:DropDownList ID="drpBonusMarksHeigthGrd" runat="server" Width="25Px">
                                                  ...
                                                  <asp:TemplateField HeaderText="Run<br/>(1.6 k.m.)">
                                                         ...
                                                         <asp:DropDownList ID="drpRunningGrd" runat="server"  Width="25Px" >
                                                  ...
                                                  <asp:TemplateField HeaderText="High<br/> Jump">
                                                       <EditItemTemplate>
                                                         ...
                                                         <asp:DropDownList ID="drpHighJumpGrd" runat="server"  Width="25Px">
                                                 ...
                                                 <asp:TemplateField HeaderText="Broad<br/> Jump">
                                                         ...
                                                         <asp:DropDownList ID="drpBroadJumpGrd" runat="server" Width="25Px">
                                                 ...
                                                 <asp:TemplateField HeaderText="Rope <br/>Climb">
                                                        ...
                                                        <EditItemTemplate>
                                                         ...
                                                         <asp:DropDownList ID="drpRopeClimbingGrd" runat="server" Width="25Px">
                                                ...
                                                <asp:TemplateField HeaderText="Cross<br/> Country">
                                                        ...
                                                        <EditItemTemplate>
                                                         ...
                                                         <asp:DropDownList ID="drpCrossCountryGrd" runat="server" Width="25Px">
                                                  ...
                                                  <asp:TemplateField HeaderText="Driving">
                                                        ...
                                                        <EditItemTemplate>
                                                         ...
                                                         <asp:DropDownList ID="drpDrivingGrd" runat="server" Width="25Px">
