<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPMEventEntry.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.OISF.PM.EventEntry.frmPMEventEntry" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Physical Measurement Form  </title>
                    ...
                    <div class="box-body box-body-open">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12">
                            ...
                            <table  style="width:80%;height:60%; background-color: #f9f9f9; padding: 10px; border-top-left-radius: 2px; border-top-right-radius: 2px; border-top: 8px solid #8bbbea;  box-shadow: 3px 3px 5px #e0e0e0;"">
                               ...
                               <tr>
                                   <td colspan="4">
                                          <asp:GridView ID="grdReport" runat="server" Width="100%" pagesize="15"
                                            ...
                                            <Columns>
                                             ...
                                             RollNumber :
                                                            ...
                                                            <tr>
                                                                <td>DOB :   <asp:Label ID="lblDOB" runat="server" Text='<%# Eval("DOB").ToString() %>'></asp:Label></td>
                                                                  <td    >
                                                                    ...
                                                                    <asp:TextBox ID="txtHeight" runat="server" MaxLength="6"></asp:TextBox>
                                                                 ...
                                                                 <td    >
                                                                     ...
                                                                     <asp:TextBox ID="txtChestUnExp" runat="server" MaxLength="6"></asp:TextBox>
                                                                 ...
                                                                 <td    >
                                                                        ...
                                                                        <asp:TextBox ID="txtChestExp" runat="server" MaxLength="6"></asp:TextBox>
                                                            ...
                                                            <tr>
                                                                <td rowspan="1">
                                                                 ...
                                                                 <td colspan="3"    >
                                                                     ...
                                                                     <asp:TextBox ID="txtRemarks" runat="server" Height="21px" Width="363px"></asp:TextBox>
                                              ...
                                              <asp:GridView ID="grdBioMetric" runat="server" Width="100%" pagesize="15"
          ...
          <asp:ListItem Value="A">Absent</asp:ListItem>
            <asp:ListItem Value="P">Present</asp:ListItem>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>Remarks <asp:TextBox ID="txtRemarks" runat="server" Height="28px" Width="157px"></asp:TextBox></td>
                                                                </tr>
                                         ...
                                         <asp:GridView ID="grdMedical" runat="server" Width="100%" pagesize="15"
...
<td rowspan="2">
    <asp:DropDownList ID="drpFitness" runat="server" Height="29px" Width="120px">
         <asp:ListItem Value="F">Fit</asp:ListItem>
                    ...
                    <td>Remarks<asp:TextBox ID="txtRemarks" runat="server" Height="22px" Width="166px"></asp:TextBox> </td>
                                              ...
                                              <asp:GridView ID="grdHighJump" runat="server" Width="100%" pagesize="15"
...
<td >
                                                            ...
                                                            <tr>
                                                                <td>DOB :   <asp:Label ID="lblDOB" runat="server" Text='<%# Eval("DOB").ToString() %>'></asp:Label></td>
                                                                 <td colspan="3">Remarks<asp:TextBox ID="txtRemarks" runat="server" Height="34px" Width="374px"></asp:TextBox> </td>
                                       ...
                                       <asp:GridView ID="grdBroadJump" runat="server" Width="100%" pagesize="15"
...
<td >
                                                            ...
                                                            <tr>
                                                                <td>DOB :   <asp:Label ID="lblDOB" runat="server" Text='<%# Eval("DOB").ToString() %>'></asp:Label></td>
                                                                 <td colspan="4" rowspan="2">Remarks<asp:TextBox ID="txtRemarks" runat="server" Height="34px" Width="374px"></asp:TextBox> </td>
                                       ...
                                       <asp:GridView ID="grdRopeClimbing" runat="server" Width="100%" pagesize="15"
...
<td >
                                                            ...
                                                            <tr>
                                                                <td>DOB :   <asp:Label ID="lblDOB" runat="server" Text='<%# Eval("DOB").ToString() %>'></asp:Label></td>
                                                                 <td colspan="2" rowspan="2">Remarks<asp:TextBox ID="txtRemarks" runat="server" Height="44px" Width="199px"></asp:TextBox> </td>
                                          ...
                                          <asp:GridView ID="grdRunning" runat="server" Width="100%" pagesize="15"
...
<td >
                                          ...
                                          <asp:GridView ID="grdCrossCountry" runat="server" Width="100%" pagesize="15"
...
<td >
                                       ...
                                       <asp:GridView ID="grdSwimming" runat="server" Width="100%" pagesize="15"
...
<td >
                                             ...
                                             <asp:GridView ID="grdDriving" runat="server" Width="100%" pagesize="15"
...
<td >
                                                            ...
                                                            <tr>
                                                                <td>DOB :   <asp:Label ID="lblDOB" runat="server" Text='<%# Eval("DOB").ToString() %>'></asp:Label></td>
                                                                 <td colspan="2" rowspan="2">Remarks<asp:TextBox ID="txtRemarks" runat="server" Height="44px" Width="160px"></asp:TextBox> </td>
                                ...
                                <tr>
                                    <td colspan="3" align="center">
                                        ...
                                        <br />
                                        <a href="/WebApp/G2G/OISF/PM/EventEntry/Reports/frmPMEntryReportView.aspx">Click To View The Data Entry Report</a>
                                    </td>
                                </tr>
