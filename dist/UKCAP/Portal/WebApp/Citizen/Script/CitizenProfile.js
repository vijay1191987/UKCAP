$(document).ready(function ()
{
    ...
    if (qs["KF"] != null)
    {
        ...
        $.ajax({
            ...
            url: '/WebApp/Citizen/forms/CitizenProfile.aspx/GetKeyFieldData',
            data: '{"prefix":"","KF":"' + KF + '"}',
            processData: false,
            dataType: "json",
            success: function (response)
            {
                ...
                if (obj[0] != null)
                {
                    $('#MobileNo').val(obj[0]["Mobile"]);
                    $('#MobileNo').prop('disabled', true);
                    $('#EmailID').val(obj[0]["Email"]);
...
function readFile()
{
    if (this.files && this.files[0])
    {
        ...
        if (sizekb < 5 || sizekb > 50)
        {
            ...
            //EL("ContentPlaceHolder1_myImg").src = "/webApp/kiosk/Images/photo.png";
            //$("ContentPlaceHolder1_myImg").attr('src',"/webApp/kiosk/Images/photo.png");
            $('#File1').val('');
            return false;
        }
