<%@ Page Title="" Language="C#" MasterPageFile="~/WebAppUK/master/UKAdmin.Master" AutoEventWireup="true" CodeBehind="CitizenProfile.aspx.cs" Inherits="CitizenPortal.WebApp.Citizen.Forms.CitizenProfile" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 box-container" id="divPhoto" runat="server">
                                    ...
                                    <div class="box-body box-body-open">
                                        ...
                                        <div class="col-lg-12">
                                            <img runat="server" class="form-control" src="/webApp/kiosk/Images/photo.png" name="photocustomer" style="height: 180px" id="myImg" />
                                            <input class="camera" id="File1" name="Photoupload" type="file" />
                                            <span style="color: #a94442; display: block; margin-top: 5px; line-height: 18px;">* Photograph size should be <b style="font-weight: bold;">5KB to 50KB.</b></span>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                    </div>
                            ...
                            <div class="row" id="divAddress" runat="server">
                                <div class="col-md-6 box-container mTop15">
                                    <div class="box-heading">
                                        <h4 class="box-title" style="padding: 13px;">Permanent Address
                                        </h4>
                                    </div>
                                    <%---Start of PostalAddress----%>
                                    <div class="box-body box-body-open">
